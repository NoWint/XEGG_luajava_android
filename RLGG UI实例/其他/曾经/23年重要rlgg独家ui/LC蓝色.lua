...
uiinfo.name = '月租UI'
uiinfo.appid = '70316'
uiinfo.appkey = 'VoXbOQzNQBxNqneL'
uiinfo.rc4key = '20WkZ1fG6MK2600W'
uiinfo.version = '1.0'
uiinfo.mi_type = '3'

local uirlyunyz = getrlyunyz(uiinfo)
local uikmyz=uirlyunyz.postApi('kmlogon',{kami=UI卡密})
if type(uikmyz) ~= "table" then
gg.alert(tostring(uikmyz).."\nui没有输入卡密 请找null买卡密!")
qq.join("3359239164")
os.exit()
end
