...
layout0=luajava.loadlayout({
	...
	background=getVerticalBG({0xff00F4FF,0xff006DFF},25),
	...
	layout_marginTop="20dp",
	background=getVerticalBG({0xff75A5FF,0xffD0EDF8},25),
	...
	background=getVerticalBG({0xff5de690,0xff006DFF},25),
	...
	layout_marginLeft="190dp",
	layout_marginTop="126dp",
	background=getVerticalBG({0xffD400FF,0xff006DFF},25),
