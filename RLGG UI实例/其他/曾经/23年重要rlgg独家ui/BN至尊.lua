...
beij:setColors(({0xdd000000,0xdd00f7ff,0xdd000000}))--背景
...
background="https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwNjI5MTYxNjg0Ml85YTk3ZDI1YQ.png",
			...
			particle("这个不重要","BN全防特别版","BY YUNZHU",{"#f2ff00","#ffffff","#f2ff00"}),
			        changan.switch("退出插件",
						function()
						window:removeView(floatWindow)
				luajava.setFloatingWindowHide(false)
...
layout_width="60dp",
layout_height="60dp",
background="https://cdn-community.codemao.cn/47/community/d2ViXzUwMDFfMTAwMTQwOTNfMTQ2NzVfMTcwNjI5MjM1Mzc2Nl9lMWQ0NDBmMg.png",
}),
			particle("这个不重要","云烛UI","BY YUNZHU",{"#2000ff","#ff0000","#2000ff"}),
