info = {
		...
		name = 'BL全防',
		appid = '42454',
		appkey = '44sDw63wX4H47Law',
		rc4key = 'n5UJy31V7Fu6fN3S',
		version = '1.0',
		mi_type = '3'
	}
...
if 流光 then
	...
	ckou={
		...
		background=newbg({0xaa161616,0xCD7F32},0,0xCD7F32,25,25,25,25),
		{LinearLayout,
...
selector:addState({
	android.R.attr.state_pressed
}, getVerticalBG({0x22161616,0xCD7F32},30))
selector:addState({
	-android.R.attr.state_pressed
}, empty)
return selector
...
topbar = luajava.loadlayout({
	...
	layout_height="35dp",
	background=getCorner({0xffffffff,0xCD7F32},15,0,0xCD7F32,20,20,0,0),
	onClick=function() end,
	onTouch=hanshu,
	{LinearLayout,
	layout_width="35dp",
	...
	gravity="center",
	{
			...
			id="lockui",
			src = getRes("heis"),
			background=getVerticalBG({0xffE6E6E6,0xCD7F32},90),
			layout_width = "20dp",
			layout_height = "20dp",
...
floatWindow = {
	...
	elevation='2dp',
		...
		background=newbg({0xff2E2E2E,0xCD7F32},0,0xCD7F32,25,25,25,25),
		topbar,
			{LinearLayout,
				layout_width='match_parent',
				layout_height='40dp',
		...
		background=newbg({0xffffffff,0xCD7F32},4,0xffffffff,0,0,50,50),
				stit
			},
		{LinearLayout,
		layout_width='match_parent',
		layout_height='40dp',
		background=getVerticalBG({0xaa161616,0xCD7F32},180,0,0xffffffff),
		{LinearLayout,
			layout_weight=1,
				layout_height='34dp',
				layout_marginTop='3dp',
		...
		layout_marginTop='3dp',
				...
				background=getVerticalBG({0x00ffffff,0xCD7F32},360,4,0xffffffff),
				src=getRes('bm_music'),
				padding='4dp',
	...
	layout_width='match_parent',
	orientation="vertical",
	background=getVerticalBG({0xffffffff,0xCD7F32},25,2,0xaa161616),
	
		{LinearLayout,
			layout_width="match_parent",
			layout_height="40dp",
			background=getCorner({0xff161616,0xCD7F32},25,nil,nil,25,25,0,0),
			onClick=function() end,
			onTouch=hanshu,
			gravity="center_vertical",
			{ImageView,
				...
				layout_width="34dp",
				src=getRes("opoback"),
				background=getVerticalBG({0x00ffffff,0xCD7F32},360,10,0xffffffff),
				padding="8dp",
				onClick=关闭窗口,
	...
	layout_width="20dp",
	gravity="center",
	background=getCorner({0x88161616,0xCD7F32},12,0,0xff232323,0,35,35,0),
...
xze2=getVerticalBG({0x00ffffff,0xCD7F32},15,3,0xff232323)

xze=getVerticalBG({0x00ffffff,0xCD7F32},15,3,0xff232323)
function xuanse(x)
for i=1,#颜色表 do
...
卡网="https://www.qtengc.com/links/116EC47C"
loadingBox = getLoadingBox('正在启动...')
loadingBox['显示']()
悬浮窗图标="https://vip.kyun.top/view.php/2219fcd7a3a7f4620152e30a6b18e2f9.png"
