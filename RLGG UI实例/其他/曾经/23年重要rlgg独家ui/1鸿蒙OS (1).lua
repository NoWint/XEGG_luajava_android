...
FrameLayout,
	...
	{LinearLayout,
		visibility = "visible",
		background="https://wp.td88.cyou/view.php/53d07dc0667b97c5e3a8d0647b07c303.png",
		padding="10dp",
...
jianbians:setColors({0xA8EA8431,0x6C00EFFF})
...
jianbians:setGradientType(GradientDrawable.LINEAR_GRADIENT)
jianbians:setColors({0xA8EA8431,0x31070409,0x6C00EFFF})
