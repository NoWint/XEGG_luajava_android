...
floatWindow:setBackground(getVerticalBG({颜色表[x][1],颜色表[x][2]},35))
选=x
end


颜色表={--切换颜色的列表
{0xffF2F3F5,0xffF2F3F5},{0x9000f4ff,0x90006dff},{0x90fff7ad,0x90ffa9f9},{0x908c52ff,0x9000bf63},{0x905170ff,0x90ff66c4},{0x90ff3131,0x90ff914d},{0x9000f4ff,0x90006dff},{0x90000000,0x90737373},{0x90000000,0x903533cd},{0x902000ff,0x90ff0000},{0x90dae1eb,0x9094b9ff},{0xffF2F3F5,0xffF2F3F5},{0xffFF95F2,0xff514CFF},{0xff008CFF,0xffFF8AFB},{0xffFF0023,0xffAD3ACD},{0xffFFB94D,0xffFF854D},{0xff33AF61,0xff5ADAD7},{0xe8905AFF,0x88FF4358},{0xe800FFC1,0x8800AFFF},{0xe80079FF,0x88FF76B8},{0xe84B7CFF,0x88974BFF}
}
function qz()
隐藏()
切换(1)
