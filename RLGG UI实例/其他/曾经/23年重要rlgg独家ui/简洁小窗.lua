...
ckimg = {
	...
	"bm_sz","bm_launch","bm_music","bm_sz","bm_gn","safe",
	"pubg.wav","zssm.wav","wow.wav",
}
for i = 1,#ckimg do
jindu = i
checkimg(ckimg[i])
...
if not name then name = "未设置" end
local rstt = changan.intswitch2(name,func1,func2)
rest[#rest+1] = rstt
end
return luajava.loadlayout({
	LinearLayout,rest
...
swits={}
function changan.intswitch2(name,func1,func2)
nid = name..guid()
swits[nid]={
...
---侧边标题和图标
	{
		"启动","https://escape2020-1303126286.cos.ap-shenzhen-fsi.myqcloud.com/bm_launch"
	},
	{
