...
slcta = getVerticalBG({0xffab0000,0xffab0000},13,2,0xffff0000)
...
--padding = "10dp",
	...
	background = getVerticalBG({0x78000000,0x78000000},18,3,0xffff0000),
	{
		LinearLayout,
		id = "layoutm"..i,
...
ckou = {
	...
	padding='3dp',
	{
		...
		padding = "2dp",
		layout_height='match_parent',
		background=getVerticalBG({0x78000000,0x78000000},18,3,0xffff0000),--左侧
		{
			LinearLayout,
			gravity = "center",
			{
...
beij = getVerticalBG({0x78ff0000,0x78EE9346},20,3,0xffab0000)
...
_ENV[bian] = nows
local thum= getVerticalBG({0xffab0000,0xffab0000},8,3,0xffff0000)
thum:setSize(20, 50)
...
rest = luajava.loadlayout({
	...
	gravity='center_vertical',
	{
		...
		gravity = "center_vertical",
		background=getVerticalBG({0xffffffff,0xffffffff},3,3,0x86FFFFFF),
		{
			SeekBar,
			layout_width = 'match_parent',
			min = truesmin,
...
if not checkbg then
	checkbg = getVerticalBG({0xffab0000,0xffab0000},90)
...
selector:addState({
	android.R.attr.state_pressed
}, getVerticalBG({0xffff0000,0xffff0000},10,2,0xff232323))
selector:addState({
	-android.R.attr.state_pressed
}, getVerticalBG({0xffab0000,0xffab0000},10,2,0xffff0000))
return selector
end
...
function 二级分页(tab)
	...
	local tmp={
		...
		{LinearLayout,
			padding='2dp',
			background=getVerticalBG({0xffab0000,0xffab0000},15),
			{TextView,
				text=tab['第1页名字'],
				textSize='11sp',
				textColor='#000000',
...
左上角图标='https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcxODUyNTc1MDAyMl8xNmMwNjNjZg.png'

小悬浮窗图标 = "https://escape2020-1303126286.cos.ap-shenzhen-fsi.myqcloud.com/Yunzhu"
--悬浮窗链接或路径
