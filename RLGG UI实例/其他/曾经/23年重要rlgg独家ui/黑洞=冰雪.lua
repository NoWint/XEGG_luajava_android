...
local function simpleTagCloudView(data)
	...
	for i=1,#stab do
		local textView = luajava.loadlayout({
			...
			padding="3dp",
			gravity = "central",
			background=getVerticalBG({0xaa0072FF,0xaa00B9FF},360,2,0xff232323),
...
_ENV["layout"..i] = luajava.loadlayout({
	...
	background="https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcxMDA3NzkwMTI0OF9jNmEwZjAxOA.png",
	{
		TextView,
		layout_width = "match_parent",
		padding = {
...
ckou = {
		...
		layout_height='match_parent',
		orientation = "vertical",
		background="https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcxMDA3Nzg2MDc0MF80ODhjZGViNA.png",
		id="cbian",
		{
		FrameLayout,
		layout_width = '198dp',
...
ckou = luajava.loadlayout({
	...
	LinearLayout,
		...
		gravity = "top",
		orientation = "vertical",
		background="https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcxMDA3NzkyNDIyOF9mY2Y2NTZjZA.png",
		onTouch=hanshu,
	{LinearLayout, 
		layout_width='match_parent',
