...
beij:setColors(({0xcc000000,0xdd00f7ff,0xcc000000}))--背景
...
beij2:setColors(({0xcc000000,0xdd00f7ff,0xcc000000}))--背景
...
luajava.runUiThread(function()
	...
	if not yck then ycg=810 yck=950 end
	...
	ckou:setBackground(beij)
		...
		mainLayoutParams.height=200
		mainLayoutParams.width=200
		window:updateViewLayout(floatWindow, mainLayoutParams)
...
suof.onTouch=suofang  rest = luajava.loadlayout({
...
stitle = "http://pan.rlyun.asia/api/v3/file/get/68965/ins1.png?sign=4WjUWSQ7GTw2HwwWd8wfOa2ChaxsOMFaG7EHVz1o7ds%3D%3A0"
stab = {
...
onClick = function() 切换(1) cebian:setVisibility(View.VISIBLE) end
}),
