...
suofang = function(v, event)
			...
			if 颜色 == 1 then
            beij:setStroke(8,"0xffF2F3F5")
            else
			beij:setStroke(8,"0xff0062FF") 
			颜色=1
			end
	    end
...
if panduan("/sdcard/YY/图片/"..tmp) ~= true then
gg.toast("正在加载资源"..tmp)
download("https://wp.td88.cyou/view.php/1d28d367be080e280413847821712975.png"..tmp,"/sdcard/YY/图片/"..tmp)
download("https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwNzk3ODA0OTgyMF83NmVhOWQ1Ng.png"..tmp,"/sdcard/YY/图片/"..tmp)--叉叉图片
download("https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwNzk3ODA2OTQzOF9iZDhkODMwOA.png"..tmp,"/sdcard/YY/图片/"..tmp)--不知道叫什么好
download("https://wp.td88.cyou/down.php/1f8c38a24d8adda4f8f4f897ab2abfbd.png"..tmp,"/sdcard/YY/图片/"..tmp)
download("http://jiami.guimei.work/a/"..tmp..".png","/sdcard/YY/图片/"..tmp)
end
end
function 获取图片(txt)
ntxt=string.sub(string.gsub(txt,"/","."),-10,-1)
if string.find(tostring(txt),"http")~=nil then
    if panduan("/sdcard/YY/图片/"..ntxt)==false then
    download(txt,"/sdcard/YY/图片/"..ntxt)
    end
    txt="/sdcard/YY/图片/"..ntxt
end
...
ckimg = {
	...
	"1695433514",
	"1695461082",
	"Image_1707976851362.png",
	"Image_1707976852814.png",
...
FrameLayout,
	...
	{LinearLayout,
		...
		onTouch=hanshu,
			...
			{LinearLayout,
		visibility = "visible",
		background="https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwNzk3ODA2OTQzOF9iZDhkODMwOA.png",
		padding="10dp",
	...
	{LinearLayout,
		visibility = "visible",
		background="https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwNzk3ODA0OTgyMF83NmVhOWQ1Ng.png",
		padding="10dp",
		layout_marginTop="7dp",
...
motion=luajava.loadlayout({FrameLayout,
			...
			{LinearLayout,
			    layout_width = "match_parent",
             	layout_height = "50dp",
				id="dibian",
				background = getCorner({0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF},30,0,0xff0097FF,0,0,20,20),
				visibility="gone",
				layout_gravity="bottom",
		        cebian
		     	},
...
ttview:setBackground(luajava.getBitmapDrawable("/sdcard/ /图片/1695461082"))
else
tview:setVisibility(View.GONE)
ttview:setBackground(luajava.getBitmapDrawable("/sdcard/YY/图片/1695433514"))
end
end
...
firadio[#firadio+1] = {
	...
	background = getSelector3(),
	{
							...
							background = "/sdcard/YY/图片/1695433514",
							layout_width = "16dp",
							layout_height = "16dp",
						} ,
	{
...
nid = name..guid()
		...
		},
        {
            ...
            background = "https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwODAwMzEyOTQ2OF8wZjI1YjQ4OA.png",
            onClick = function() luajava.newThread(function() func() end):start() end,
            layout_width = '45dp',
            layout_height = '25dp',
        	},{
            ...
            background = "https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwODAwMzE2Mjc3NF9iY2YxNjFhMQ.png",
            onClick = function() luajava.newThread(function() func() end):start() end,
            layout_width = '45dp',
            layout_height = '25dp',
        	}
