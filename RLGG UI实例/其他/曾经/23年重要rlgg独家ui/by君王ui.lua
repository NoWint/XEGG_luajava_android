...
for a = 1,#stab-2 do
	for b = 1,4 do
		...
		if b==1 then
			_ENV["switchs"..a..b][#_ENV["switchs"..a..b]+1]=yz.text("\n\n\n\n\n\n\n\n\n\n\n\n\n\n")[1]
		end
	end
end
...
gggscro=luajava.loadlayout
							...
							{
								TextView,
								text = string.fromHtml(getTimeStamp(os.time()).." <font color=#97B9FF>".."YZ天御守护您的数据安全".."</font>"),
								textSize = "12sp",
								textColor = color,
								gravity="left",
								layout_width = "wrap_content",
...
luajava.runUiThread(function()
	yz.controlSmall(floatWindow,400)
	end)
gg.sleep(400)
luajava.runUiThread(function()
...
function tosearch(besearch)
	...
	local result=lt.."个结果，请手动执行","#ffffff")
			end
		end
	end
	luajava.newThread(function()
...
function yz.switch(name,func1,func2)
nid = name..guid()
...
chazhi={} chajv={}
function yz.seek(name,bian,smin,smax,nows)
local thum=getShape(
	10,
	{
...
function yz.text2(txt,color,size)
...
function yz.text(txt,color,size)
if not txt then txt = "未设置文字" end
if not color then color = "#ffffff" end
if not size then size = "14sp" end
return {luajava.loadlayout(
...
bglist={
	getShape(30,{0xe80079FF,0x882000FF},0,0x01B8B8B8),
...
stitle="欢迎使用YZ天御 Q群818963998 电报频道@XEWLYZ"
...
---侧边标题和图标
	{
		"防封","https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwNjUyNTg1MTY4NV80ZmRmNjBjMw.png"
	},
	{
		"功能","https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwNjUyNTg1MTY4NV80ZmRmNjBjMw.png"
	},
	{
		"美化","https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwNjUyNTg1MTY4NV80ZmRmNjBjMw.png"
	},
	{
		"音乐","https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwNjUyNTg1MTY4NV80ZmRmNjBjMw.png"
	},
	{
		"启动","https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwNjUyNTg1MTY4NV80ZmRmNjBjMw.png"
	},
	{
		"设置","https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwNjUyNTg1MTY4NV80ZmRmNjBjMw.png"
	},
