...
ckou = {
	...
	orientation = "vertical",
	{
		...
		gravity="center_vertical",
		{
			...
			layout_height = "30dp",
			gravity = "center",
			onClick = function() 切换(1) cebian:setVisibility(View.GONE) end,
			onTouch = hanshu,
		},
		cebian,
		{ImageView,
...
floatWindow = {
	...
	ckou,
	{
		...
		layout_height = "40dp",
		onTouch = hanshu,
		onClick = function() 隐藏() cebian:setVisibility(View.GONE) 切换(1) end,
	},
	motion
}
...
luajava.runUiThread(function()
	...
	if not yck then ycg=1500 yck=950 end
...
onClick = function() 切换(2) cebian:setVisibility(View.VISIBLE) end
}),
