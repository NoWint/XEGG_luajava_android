...
slcta = getCorner({0xff5E141C,0xff5E141C},15,4,0xff972822,0,35,0,35)
slctb = getCorner({0xdd161616,0xdd161616},15,4,0xff3B7BC5,0,35,0,35)
...
background = getCorner({0xff161616,0xaa161616},23,2,0xff7B2023,0,20,0,20),
{
	LinearLayout,
	id = "jm1",
	layout_height = "35dp",
...
layout6,cebian,layout1,layout2,layout3,layout4,layout5
	})
	floatWindow = {
LinearLayout,
background={
...
layout_width = "match_parent",
	...
	id="suox",
	visibility="gone",
	background=获取图片("https://rl-1303126286.cos.ap-beijing-fsi.myqcloud.com/quarkx"),
	layout_height="32dp",
	layout_width="32dp",
...
if 当前ui == 1 then
	...
	elseif 当前ui == 6 then
	layout6:setVisibility(View.VISIBLE)
	YoYoImpl:with("FadeIn"):duration(200):playOn(layout6)
end
	end)
end
显示 = 0
...
if 当前ui == 1 then
	...
	layout6:setVisibility(View.VISIBLE)
	YoYoImpl:with("FadeIn"):duration(800):playOn(layout6)
end
...
背景图="https://rl-1303126286.cos.ap-beijing-fsi.myqcloud.com/mmexport1706789680698.png"
stab={
	"云烛全防",
	"xx功能",
	"xx功能",
