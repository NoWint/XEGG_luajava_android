...
local webView = luajava.webView(function(webView)
	...
	<!DOCTYPE html>
<html>
<img src="https://rl-1303126286.cos.ap-beijing-fsi.myqcloud.com/fire.gif" alt="YZandYC" style="max-height: 50px; max-width: 50px;">
...
getcolor = luajava.getStateListDrawable()
getcolor:addState({
	android.R.attr.state_pressed
}, getCorner({0xFFDFDFDF,0xFFDFDFDF},30,0,0xff0097FF,20,20,20,20)) -- 点击时候的背景
getcolor:addState({
	-android.R.attr.state_pressed
}, getCorner({0x00000000,0x00000000},30,0,0xff0097FF,20,20,20,20)) -- 没点击的背景
			...
			{LinearLayout,
				...
				{LinearLayout,
					...
					{LinearLayout,
						...
						{
								TextView,
								text = string.fromHtml("<font color=#545454>".."欢迎使用鸿蒙4.0小窗","</font>"),
								textSize = "15sp",
								textColor = color,
								gravity="left",
								layout_width = "match_parent",
...
motion=luajava.loadlayout({FrameLayout,
			...
			{LinearLayout,
			    layout_width = "match_parent",
             	layout_height = "43dp",
	            background = getCorner({0xffF2F3F5,0xffF2F3F5},30,0,0xff0097FF,0,0,30,30),
				id="dibian",
				visibility="gone",
...
floatWindow = {
	...
	motion,
	{
			...
			gravity = "center", {
				...
				layout_width = "50dp",
				layout_height = "50dp",
				onClick = function() 隐藏() vibra:vibrate(9) end
			}},
...
-----------------------------------------------------
	...
	changan.blank("40dp")	--每一页的最后面必须加这个
