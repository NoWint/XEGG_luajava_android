...
while true do
	...
	if tostring(gg.getTargetPackage()) == pkg then
		loadingBox['关闭']()
		gg.alert("启动成功")
		uiadtext("启动成功.","#"..string.sub(string.format("%x", 开关颜色[1]),3,-1))
		break
	else
		jci=jci+1
		if jci==14 then
			loadingBox['关闭']()
			gg.alert("自动获取进程失败\n请手动选择游戏进程")
			uiadtext("启动失败.","#"..string.sub(string.format("%x", 开关颜色[1]),3,-1))
			gg.setProcessX()
			break
		end
	end
...
FrameLayout,
	...
	onTouch=hanshu,
		...
		gg.sleep(100)
		uiadtext("已放大.","#"..string.sub(string.format("%x", 开关颜色[1]),3,-1))
		...
		onClick= function() 
		vibra:vibrate(9)
		uiadtext("已缩小.","#"..string.sub(string.format("%x", 开关颜色[1]),3,-1))
		...
		onClick= function() 
		vibra:vibrate(9)
		uiadtext("UI缩放已锁定.","#"..string.sub(string.format("%x", 开关颜色[2]),3,-1))
		缩放=1 
		...
		onClick= function() 
		vibra:vibrate(9)
		uiadtext("UI缩放已解锁.","#"..string.sub(string.format("%x", 开关颜色[1]),3,-1))
		缩放=nil 
			...
			{LinearLayout,
				...
				{LinearLayout,
					...
					{LinearLayout,
						...
						{
								TextView,
								text = string.fromHtml("<font color=#545454>".."欢迎使用云烛UI","</font>"),
								textSize = "15sp",
								textColor = "#545454",
								gravity="left",
								layout_width = "match_parent",
						...
						{
								TextView,
								text = string.fromHtml("<font color=#545454>".."本UI启动时间:"..getTimeStamp(os.time()).."</font>"),
								textSize = "15sp",
								textColor = "#545454",
								gravity="left",
								layout_width = "match_parent",
...
qd1=luajava.loadlayout({LinearLayout,
		layout_height = "100dp",
		layout_width = "match_parent",
		id = "qd1",
		orientation = "horizontal",
		gravity="center",
		{
			...
			},
			{
				...
				YoYoImpl:with("FadeIn"):duration(400):playOn(qd2)
			...
			background = getVerticalBG({0xff004EFF,0xff004EFF},38),
			{
			TextView,
			textColor = "#ffffff",
			text = "启动",
...
----------------------------------------------
qd2=luajava.loadlayout({LinearLayout,
		layout_height = "100dp",
		layout_width = "match_parent",
		orientation = "horizontal",
		visibility = "gone",
		...
		gravity="center",
		{
			...
			},
			{
				...
				YoYoImpl:with("FadeIn"):duration(400):playOn(qd3)
...
----------------------------------------------
qd3=luajava.loadlayout({LinearLayout,
		layout_height = "100dp",
		layout_width = "match_parent",
		orientation = "horizontal",
		visibility = "gone",
		...
		gravity="center",
		{
			...
			},
			{
				...
				layout_width="60dp",
				onClick = function() 
				qd3:setVisibility(View.GONE)
				YoYoImpl:with("FadeIn"):duration(400):playOn(qd4)
...
----------------------------------------------
qd4=luajava.loadlayout({LinearLayout,
		layout_height = "100dp",
		layout_width = "match_parent",
		orientation = "horizontal",
		visibility = "gone",
		...
		gravity="center",
		{
			...
			},
			{
				...
				YoYoImpl:with("FadeIn"):duration(400):playOn(qd1)
...
隐藏()
切换(1)
uiadtext("请阅读使用说明","#"..string.sub(string.format("%x", 开关颜色[1]),3,-1),"15sp")
end
