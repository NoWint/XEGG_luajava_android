...
luajava.runUiThread(function()
	for i = 1,#stab do
	_ENV["jmt"..i]:setTextColor(0xffffffff)
...
checkbg2 = getShape2(
	...
	4,0xff80C3F9)
checkbg2=获取图片("/sdcard/长安/图片/leimu")
...
vibra:vibrate(14)
luajava.runUiThread(function()
	luajava.getIdValue(nid.."g"):setText("已开启")
...
luajava.runUiThread(function()
	...
	luajava.getIdValue(nid.."g"):setTextColor(0xff4a4458)
...
--0x00444444,0x00ffffff
	0xff2f2e36,0xff2f2e36---这个是按钮的背景的颜色
})
jianbians:setOrientation(GradientDrawable.Orientation.LEFT_RIGHT)
