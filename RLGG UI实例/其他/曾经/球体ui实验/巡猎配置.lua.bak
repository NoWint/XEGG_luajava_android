...
stit=luajava.loadlayout{ShimmerTextView,
	...
	background="https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcxODQzNzc2MjUyNF8wZGQ4MDExZQ.png",
...
yck=mainLayoutParams.height
mainLayoutParams.height=yck+50
luajava.runUiThread(function()
window : updateViewLayout (floatWindow , mainLayoutParams)
end)
end
...
if 显示 == 1 then
if mainLayoutParams.height > 300 then
