...
dex.loadfile("/sdcard/LuajavaDev8/龙年/CircleImageView.dex")
import("android.widget.CircleImageView")
shimmer=dex.loadfile('/sdcard/LuajavaDev8/龙年/Shimmer2.dex')
...
function getRes(x)
  return 获取图片("/sdcard/LuajavaDev8/龙年/"..x)
end
function 获取图片(txt)
  ntxt = string.sub(string.gsub(txt,"/","-"),-10,-1)
  if string.find(tostring(txt),"http") ~= nil then
    if panduan("/sdcard/LuajavaDev8/龙年/"..ntxt) == false then
      download(txt,"/sdcard/LuajavaDev8/龙年/"..ntxt)
    end
    txt = "/sdcard/LuajavaDev8/龙年/"..ntxt
  end
...
dexloader=dex.loadfile('/sdcard/LuajavaDev8/龙年/classes3.dex')
...
YC.menu = function(sview)
  local path = '/sdcard/LuajavaDev8/龙年/tagcloud'
  ...
  function 切换(x)
    ...
    luajava.runUiThread(function()
      for i = 1, #stab do
        ...
        _ENV["jm" .. i]:setBackground(getVerticalBG({0x50161616,0x50161616},8,2,0x50161616))
        _ENV["layout"..i]:setVisibility(View.GONE)
      end
      _ENV["jmt" .. 当前ui]:setTextColor(0xff864434) --选中的字体颜色
      _ENV["jm" .. 当前ui]:setBackground(getHorizontalBG({0xFF9D3D2A,0xFFFEC184},8,2,0xFF974126))
  ...
  local function simpleTagCloudView(data)
    ...
    for i = 1, #stab do
      local textView = luajava.loadlayout({
        ...
        end,
        {
          ...
          layout_width = "30dp",
          gravity = "center",
          background = getVerticalBG({0x50161616,0x50161616},8,2,0x50161616),
          {
            ImageView,
            gravity = "center",
            layout_height = "23dp",
    ...
    tagCloudView:setScrollSpeed(5)
    tagCloudView:setRadiusPercent(0.6)
    tagCloudView:setAutoScrollMode(0)
    return tagCloudView
  end
  tagCloudView=simpleTagCloudView(stab)
  Page = {
    LinearLayout,
  ...
  wz = luajava.loadlayout{
    ShimmerTextView,
    text = 大标题and免费uiQQ频道号LuajavaDev8,
    reflectionColor="#FFDD60",
    textSize = "16sp",
    textColor = "0xff854333",
  }
  Menu = luajava.loadlayout{
    ...
    id="menu",
    layout_height = "320dp",
    background = "/storage/emulated/0/LuajavaDev8/龙年/dragbg",
    {
      FrameLayout,
      layout_height = "200dp",
      layout_width = "134dp",
      layout_marginLeft = "46dp",
      ...
      },
      {
        ...
        gravity = "center",
        textColor = "0xff854333",
        background = getHorizontalBG({0x009D3D2A,0x00FFC67C},5,1,0xFFA13D23),
  ...
  floatWindow = {
    ...
    },
    {
      ...
      src = "/storage/emulated/0/LuajavaDev8/龙年/dragx",
      onClick = function() 隐藏() end,
      layout_width = "28dp",
      layout_height = "28dp",
  ...
  YC.controlSmall = function(control,time)
luajava.runUiThread(function()
...
YC.controlBig = function(control,time)
luajava.runUiThread(function()
	import "android.animation.ObjectAnimator"
	ObjectAnimator():ofFloat(control,"scaleX", {
		0, 0.4, 0.7, 1
  ...
  if yc == 1 then
   ...
   luajava.runUiThread(function()
    ...
    gg.sleep(500)
    luajava.runUiThread(function()
    dragx:setVisibility(View.VISIBLE)
   ...
   luajava.newThread(function()
   luajava.runUiThread(function()
    YC.controlSmall(Menu,500)
    dragx:setVisibility(View.GONE)
  ...
  while true do
    ...
    jianting3(qiehuan)
    time:setText(""..os.date("%Y/%m/%d %H:%M:%S"))
    gg.sleep(120)
  end
end
function 退出UI()
...
function getButtonBG()
  ...
  }, getHorizontalBG({0x34000400,0x34000400},5))
  selector:addState({
    -android.R.attr.state_pressed
  }, getHorizontalBG({0xFF9D3D2A,0xFFFFC67C},5,3,0xFFA13D23))
  return selector
end
buts={}
...
function YC.switch2(name,func1,func2,miaoshu)
  if not checkbg then
    checkbga = getHorizontalBG({0xffF3DABC,0xffF3DABC},360,3,0xFFA13D23)
    checkbg = getHorizontalBG({0xffBA5033,0xffFBC77B},360,3,0xFFA13D23)
    switchbg1 = getHorizontalBG({0xFF9D3D2A,0xFFFFC67C},360,4,0x00ffffff)
    switchbg2 = getHorizontalBG({0xffBA4C33,0xffBA4C33},360,4,0x00ffffff)
  end
  nid = name..guid()
  ...
  rest = luajava.loadlayout({
    ...
    gravity = "center",
    {
      ...
      layout_marginRight = "20dp",
      layout_marginLeft = "20dp",
      background = getHorizontalBG({0xFf9D3D2A,0xffFFC67C},5,3,0xFFA13D23),
      padding = {
        "0dp","0dp","6dp","0dp"
      },
{
...
luajava.runUiThread(function()	
	...
	luajava.getIdValue(nid.."g"):setBackground(getHorizontalBG({0xFfC24C38,0xffF78F5C,0xFfC24C38},5,3,0xFFA13D23))
	end)
_ENV[name] = "开"
vibra:vibrate(6)
pcall(func1)
	...
	luajava.getIdValue(nid.."k"):setBackground(getHorizontalBG({0xFfC24C38,0xffF78F5C,0xFfC24C38},5,3,0xFFA13D23))
	end)
_ENV[name] = "关"
vibra:vibrate(6)
pcall(func2)
...
local rest = luajava.loadlayout({
		...
		},
	{
		...
		text="关",		
		id = luajava.newId(nid.."k"),
		background = getHorizontalBG({0xFfC24C38,0xffF78F5C,0xFfC24C38},5,3,0xFFA13D23),
		textColor="#781E18",
		layout_width = '40dp',
		gravity = "center",
		layout_height = '25dp',
...
xfcpic="http://q1.qlogo.cn/g?b=qq&nk=1527167810&s=40"
大标题and免费uiQQ频道号LuajavaDev8="龙年全源"
...
---龙年免费模板 泛滥qq频道号LuajavaDev8 打开手机qq搜索即可加入
---龙年免费模板 泛滥qq频道号LuajavaDev8 打开手机qq搜索即可加入
---龙年免费模板 泛滥qq频道号LuajavaDev8 打开手机qq搜索即可加入
---龙年免费模板 泛滥qq频道号LuajavaDev8 打开手机qq搜索即可加入
---龙年免费模板 泛滥qq频道号LuajavaDev8 打开手机qq搜索即可加入
...
---请不要删上面的内置代码，否则失效
---加入qq频道以免费获得更多公益ui和了解第一手ui情报
---打开手机qq搜索频道号即可加入 频道号LuajavaDev8
---内含materialDesign3的materialSwitch以及tagcloud
...
YC.menu({
	...
	YC.switch("开关",function() end,function() end),
	YC.switch2("开关",function() end,function() end),---m3开关
	YC.edit('输入框例子'),
		YC.button(
			'调用',
			function()
				local t=YC.getedit('输入框例子')
				gg.alert(t)
			end),
	YC.check({
				{
