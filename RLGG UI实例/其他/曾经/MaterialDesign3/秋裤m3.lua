...
if panduan("/storage/emulated/0/云烛/RLGG/秋裤.zip") ~= true then
  gg.toast("正在下载资源秋裤.zip\n请耐心等待")
  file.download("http://43.139.24.211/wanqi/down.php/97992efcaaaf0ec466844ac4bc1f6cdb.zip","/storage/emulated/0/云烛/RLGG/秋裤.zip")
end
if panduan("/storage/emulated/0/云烛/RLGG/CircleImageView.dex")~=true then
  file.unzip("/storage/emulated/0/云烛/RLGG/秋裤.zip","/storage/emulated/0/云烛/RLGG/")
end
dex.loadfile("/storage/emulated/0/云烛/RLGG/CircleImageView.dex")
import("android.widget.CircleImageView")
shimmer=dex.loadfile('/storage/emulated/0/云烛/RLGG/Shimmer2.dex')
...
YC.menu = function(sview)
    ...
    bulletinb[#bulletinb + 1] = {
      ...
      end,
      {
        ...
        },
        {
          ...
          src = "/storage/emulated/0/云烛/RLGG/heir.png",
          ColorFilter = "#111111",
        },
      },
      {
        ...
        background = getVerticalBG({ 0x90DDDDDD, 0x90DDDDDD }, 360),
      },
    }
  end
  ...
  bulletin=luajava.loadlayout{
    ...
    layout_marginLeft = "3dp",
    {
      ...
      layout_gravity = "left",
      layout_marginLeft = "3dp",
      src = "/storage/emulated/0/云烛/RLGG/bulletinb.png",
    },
    {
      ScrollView,
      layout_width = "match_parent",
  ...
  {
    TextView,
    text = string.fromHtml(" <font color=#000000>VIP·</font> <font color=#A5A5A5>未登录</font>"),
    textSize = "11sp",
    --textColor = color,
    gravity="left",
  ...
  Lmenu = {
    ...
    orientation = "vertical",
    {
      ...
      {
        CircleImageView,
        src = "http://q1.qlogo.cn/g?b=qq&nk=3687782427&s=40",
        layout_height = "40dp",
        layout_width = "40dp",
      ...
      {
        ImageView,
        src = "/storage/emulated/0/云烛/RLGG/d.com-heix.png",
        layout_height = "13dp",
        layout_width = "13dp",
      ...
      {
        ImageView,
        src = "/storage/emulated/0/云烛/RLGG/opo52.png",
        layout_height = "15dp",
        layout_width = "15dp",
        layout_gravity = "right",
      ...
      },
      {
        ...
        elevation = "2dp",
        {
          ...
          background = getVerticalBG({ 0x00ffffff, 0x00ffffff }, 10),
          {
            ...
            layout_width = "50dp",
            layout_height = "22dp",
            background = getCorner({ 0xffffffff, 0xffffffff }, 10, 1, 0x70ededed, 10, 10, 0, 0),
            elevation = "2dp",
            text = "菜单",
            textColor = "0xDD111111",
            gravity = "center",
            ...
            onClick = function()
              ...
              ejcd:setBackground(getCorner({ 0xffffffff, 0xffffffff }, 10, 1, 0x70ededed, 10, 10, 0, 0))
              ejgg:setBackground(getCorner({ 0xffB9B9B9, 0xffB9B9B9 }, 10, 1, 0x70ededed, 10, 10, 0, 0))
            end,
          },
          {
            TextView,
            layout_width = "50dp",
            layout_height = "22dp",
            background = getCorner({ 0xffB9B9B9, 0xffB9B9B9 }, 10, 1, 0x70ededed, 10, 10, 0, 0),
            elevation = "2dp",
            text = "公告",
            ...
            onClick = function()
              ...
              ejgg:setBackground(getCorner({ 0xffffffff, 0xffffffff }, 10, 1, 0x70ededed, 10, 10, 0, 0))
              ejcd:setBackground(getCorner({ 0xffB9B9B9, 0xffB9B9B9 }, 10, 1, 0x70ededed, 10, 10, 0, 0))
            end,
          },
        },
        {
          ...
          layout_width = "match_parent",
          layout_height = "match_parent",
          background = getCorner({ 0xffffffff, 0xffffffff }, 20, 0, 0x70ededed, 0, 20, 20, 20),
          Selection,
          bulletin
        },
        {
  ...
  ckou = {
    ...
    layout_height = "265dp",
    layout_width = "510dp",
    background = getVerticalBG({ 0xEDEDEDED, 0xEDEDEDED }, 20),
    Lmenu,
    {
    LinearLayout,
    orientation = "horizontal",
  ...
  floatWindow = {
    ...
    layout_height = "wrap_content",
    {
      ...
      ckou,      
      {
		CircleImageView,
		id = "control2",
		src = "http://q1.qlogo.cn/g?b=qq&nk=1527167810&s=40",
		layout_width = "45dp",
		layout_height = "45dp",
		onTouch = hanshu,
		onClick =function() 隐藏() end,
  ...
  function 切换(x)
    ...
    luajava.runUiThread(function()
      for i = 1, #stab do
        ...
        _ENV["jmi" .. i]:setColorFilter(0xff000000) --未选中的图片颜色
        _ENV["layout"..i]:setVisibility(View.GONE)
      end
      _ENV["jmt" .. 当前ui]:setTextColor(0xff004EFF) --选中的字体颜色
      _ENV["jmi" .. 当前ui]:setColorFilter(0xff004EFF) --选中的图片颜色
...
function searchmusic()
	...
	for i = 1, #musictable do
		...
		src = "/storage/emulated/0/云烛/RLGG/star.png",
		layout_width = "20dp",
		layout_height = "20dp",
		layout_gravity = "center",
		onClick =function()
		luajava.newThread(function()
file.checkFile("/storage/emulated/0/云烛/RLGG/收藏歌单/歌曲目录.lua")
dofile("/storage/emulated/0/云烛/RLGG/收藏歌单/歌曲目录.lua")
歌曲[#歌曲+1]={musnames[i]..musarts[i]..','..musids[i]}
if mlm == nil then mlm =1 end 
write("/storage/emulated/0/云烛/RLGG/收藏歌单/歌曲目录.lua",""..歌曲[1][1]) 
 end):start() end,
		},
		 {
			LinearLayout,
...
stab = {
  ...
  { "启动", "/storage/emulated/0/云烛/RLGG/bm_launch.png" },
  { "防封", "/storage/emulated/0/云烛/RLGG/opo41.png" },
  { "功能", "/storage/emulated/0/云烛/RLGG/bm_gn.png" },
  { "美化", "/storage/emulated/0/云烛/RLGG/mh.png" },
  { "音乐", "/storage/emulated/0/云烛/RLGG/bm_music.png" },
  { "设置", "/storage/emulated/0/云烛/RLGG/bm_sz.png" },
}
bulletinboard = {
...
{
  {
    ...
    YC.switch("测试",function() end,function() end),
    }, {
    YC.switch("测试",function() end,function() end),
    }, {
    YC.switch("测试",function() end,function() end),
    ...
    YC.switch("退出",function() end,function() end),
    },{
