  ...
  if 缩放 then
    ...
    if Action == MotionEvent.ACTION_DOWN then
      ...
      if x==0 or x==-2 then x=1700 y=1300 end
        ckou:setBackground(getVerticalBG({背景色,背景色},45,10,主题色))     
     elseif Action == MotionEvent.ACTION_MOVE then
      isMove = true
     ...
     elseif event:getAction() == MotionEvent.ACTION_UP then
      ckou:setBackground(getVerticalBG({背景色,背景色},45,0,0xaa232323))
    end
    window:updateViewLayout(floatWindow, mainLayoutParams)
  end
end
...
Yunzhu.menu = function(sview)
  ...
  function 切换(x)
    ...
    luajava.runUiThread(function()
      for i = 1, #stab do
        ...
        _ENV["jm"..i]:setBackground(getVerticalBG({控件色,控件色},15))--未选中的颜色
        _ENV["layout"..i]:setVisibility(View.GONE)
      end
      _ENV["jmt"..当前ui]:setTextColor(控件色)--选中的字体颜色
  ...
  for i = 1,#stab do
    cebian[#cebian+1] = {
      ...
      background=getVerticalBG({控件色,控件色},15),
      elevation = "3dp",
      onClick = function()
        切换(i)
      end,
...
Yunzhu.controlRotation9 = function(control, time,t)
  ...
  topbar = luajava.loadlayout({
    ...
    layout_width="match_parent",
    layout_height="35dp",
    background=getCorner({控件色,控件色},15,0,0xff232323,40,40,0,0),
    elevation = "3dp",
    {LinearLayout,
      layout_width="match_parent",
      layout_height="match_parent",
    ...
    {FrameLayout,
      layout_width="wrap_content",
      layout_height="match_parent",
      background=getCorner({控件色,控件色},15,0,0xff232323,45,0,0,0),
      {FrameLayout,
    ...
    {FrameLayout,
      layout_width="wrap_content",
      background=getCorner({控件色,控件色},15,0,0xff232323,0,45,0,0),
      layout_height="match_parent",
  ...
  ckou = {
    ...
    layout_height = "match_parent",
    orientation = "vertical",
    background = getVerticalBG({背景色,背景色},50),
    topbar,
    {
      LinearLayout,
      layout_height = "match_parent",
...
function Yunzhu.switch(name,func1,func2,miaoshu)
  if not checkbg then
    ...
    switchbg1 = getVerticalBG({控件色,控件色},360,4,0x00ffffff)
    switchbg2 = getVerticalBG({控件色,控件色},360,4,0x00ffffff)
  end
  nid = name..guid()
...
{
  {
    Yunzhu.switch("测试1",function()
      退出UI()
    end,function() end),
    Yunzhu.box({"测试box",
    Yunzhu.button("按钮测试",function() gg.alert("云烛牛逼") end),
    Yunzhu.button("6",function() gg.alert("6") end),
    Yunzhu.switch(
    '音量键隐藏UI',
    function()
      音量键=true
    ...
    Yunzhu.switch("测试2",function() gg.alert("开") end,function() gg.alert("关") end),
    }, {
