...
--这是没加缩放函数时的演示 一会演示加缩放函数
--可以看到没加函数无法运行改大小 下面我们加上函数
...
_ENV["layout"..i] = luajava.loadlayout({
	...
	background="https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcxODgwMDkyNzA5OF80OTRmOWY3MA.png",
	{
		TextView,
		visibility="gone",
		layout_width = "match_parent",
...
ckou = {
	...
	orientation = "vertical",
	{
		...
		gravity="center_vertical",
		{
			...
			layout_height = "30dp",
			gravity = "center",
			onClick = function() 切换(#stab+1) cebian:setVisibility(View.GONE) end,
			onTouch = hanshu,
		},
		cebian,
		{ImageView,
...
luajava.runUiThread(function()
	...
	jiaobiao:setVisibility(View.VISIBLE)------这个
	...
	ckou:setBackground(beij)
		...
		jiaobiao:setVisibility(View.GONE)------这个
...
background="https://cdn-community.codemao.cn/47/community/d2ViXzEwMDFfMTAwMTQwOTNfMTAwMTQwOTNfMTcwNjI5MTYxNjg0Ml85YTk3ZDI1YQ.png",
			...
			particle("这个不重要","YZ全防至臻版","BY YUNZHU云烛",{"#2000ff","#ff0000","#2000ff"}),
		...
		ImageView,
		id = "control",
		background = "https://wp.td88.cyou/view.php/d73ad51ad8cc274fe45c0c3f34a00bbd.png",
		layout_width = "40dp",
		layout_height = "40dp"
		},
			{
...
layout_width="300dp",
layout_height="40dp",
background="https://cdn-community.codemao.cn/47/community/d2ViXzMwMDFfMTAwMTQwOTNfMF8xNzA2MzQ0MzAwNDUwXzJjYmQyM2Zi.png",
onclick = function() app.start("com.tencent.ig") gg.setProcess("com.tencent.ig")end}),
luajava.loadlayout({
LinearLayout,
layout_width="300dp",
layout_height="40dp",
background="https://cdn-community.codemao.cn/47/community/d2ViXzMwMDFfMTAwMTQwOTNfMF8xNzA2MzQ0MzA0NTA4X2U4YjcwMmJi.png",
onclick = function() app.start("com.vng.pubgmobile") gg.setProcess("com.vng.pubgmobile")end}),
luajava.loadlayout({
LinearLayout,
layout_width="300dp",
layout_height="40dp",
background="https://cdn-community.codemao.cn/47/community/d2ViXzMwMDFfMTAwMTQwOTNfMF8xNzA2MzQ0MzEwNzU2XzU0Yjk3ZTA1.png",
onclick = function() app.start("com.rekoo.pubgm") gg.setProcess("com.rekoo.pubgm")end}),
luajava.loadlayout({
LinearLayout,
layout_width="300dp",
layout_height="40dp",
background="https://cdn-community.codemao.cn/47/community/d2ViXzMwMDFfMTAwMTQwOTNfMF8xNzA2MzQ0MzA3MzAzXzdhMWE3YzIy.png",
...
onClick  = function()  app.openUrl("https:t.me/XEWLYZ") end
}),
			particle("这个不重要","加入tg频道","BY YUNZHU云烛",{"#2000ff","#ffffff","#2000ff"}),
			changan.switch("安全退出",function()
				window:removeView(floatWindow)
				luajava.setFloatingWindowHide(false)
				luajava.newThread(function() os.exit() end):start()
				bloc("end")
				end),
			changan.button("快速退出",function()
				exit()
				end),
		}, {
--第五页，没有写菜单标题所以不显示
