...
slcta = getVerticalBG({0x78004eff,0x78004eff},13,2,0xff90c12f)
...
--padding = "10dp",
	...
	background = getVerticalBG({0xffffffff,0xffffffff},18,6,0xffd7d7d7),
	{
		LinearLayout,
		id = "layoutm"..i,
...
ckou = {
	...
	padding='3dp',
	{
		...
		padding = "2dp",
		layout_height='match_parent',
		background=getVerticalBG({0xffffffff,0xffffffff},18,6,0xffd7d7d7),--左侧
		{
			LinearLayout,
			gravity = "center",
			{
...
beij = getVerticalBG({0xfff2f3f5,0xfff2f3f5},20,3,0xffd7d7d7)
...
_ENV[bian] = nows
local thum= getVerticalBG({0x78004eff,0x78004eff},8,3,0xff90c12f)
thum:setSize(20, 50)
...
if not checkbg then
	checkbg = getVerticalBG({0x78004eff,0x78004eff},90)
...
selector:addState({
	android.R.attr.state_pressed
}, getVerticalBG({0x78004eff,0x78004eff},10,2,0xff232323))
selector:addState({
	-android.R.attr.state_pressed
}, getVerticalBG({0x78004eff,0x78004eff},10,2,0xff90c12f))
return selector
end
...
function 二级分页(tab)
	...
	local tmp={
		...
		{LinearLayout,
			padding='2dp',
			background=getVerticalBG({0x78004eff,0x78004eff},15),
			{TextView,
				text=tab['第1页名字'],
				textSize='11sp',
				textColor='#000000',
		...
		{--1
			...
			二级分页({
				...
				['第1页']={
					...
					Yunzhu.text("Caesar.","#000000","15sp"),
				Yunzhu.button('载入游戏',
						function()
						...
						Yunzhu.text("帧率平均值：114.514 \n 本机型号:YZ 分辨率 2560*1860","#000000","10sp"),
				},--第一分页收尾
				['第2页名字']='例子2',
				['第2页']={
			...
			二级分页({
				...
				['第1页']={
					...
					Yunzhu.text("下方是check1例子（单列）","#000000","20sp"),
					Yunzhu.check1({
							{
								"例子",
								function()
