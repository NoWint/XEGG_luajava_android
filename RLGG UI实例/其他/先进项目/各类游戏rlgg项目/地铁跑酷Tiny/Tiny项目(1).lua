...
gg.alert('防封防追开启成功')		
	...
	changan.switch(
			"新手教程",
			function()
SO_PT(0xbbd118 ,4,"~A MOV	 R0, #1")
gg.alert("TINY己为您开启")
			end),
		changan.button(
			"封号弹窗",
			function()
SO_PT(0x1169f50 ,4,"~A MOV	 R0, #0")
...
{
{"~A MOVW	 R0, #57600" ,4, 0xb9d484,false},
{"~A MOVT	 R0, #1525" ,4, 0xb9d484+4,false},
{"~A BX LR" ,4, 0xb9d484+8,false},--金币
{"~A MOVW	 R0, #30000" ,4, 0xb9d830,false},
{"~A MOVT	 R0, #0" ,4, 0xb9d830+4,false},
{"~A BX LR" ,4, 0xb9d830+8,false},--钥匙
{"~A MOVW	 R0, #888" ,4, 0xbe704c,false},
{"~A MOVT	 R0, #0" ,4, 0xbe704c+4,false},
{"~A BX LR" ,4, 0xbe704c+8,false},--宝物钥匙
{"~A MOVW	 R0, #520" ,4, 0xba133c,false},
{"~A BX LR" ,4, 0xba133c+4,false},--等级
{"~A MOVW	 R0, #6" ,4, 0xbe0534,false},
{"~A BX LR" ,4, 0xbe0534+4,false},--跑卡
{"~A MOV	 R0, #1" ,4, 0x2cfaf40,false},
{"~A BX LR" ,4, 0x2cfaf40+4,false},--十倍调出
{"~A MOV	 R0, #1" ,4, 0x14f2b0c,false},
{"~A BX LR" ,4, 0x14f2b0c+4,false},--十倍获取
{"~A MOV	 R0, #1" ,4, 0x1755b44,false},
{"~A BX LR" ,4, 0x1755b44+4,false},--微博
{"~A MOV	 R0, #1" ,4, 0xb87e9c,false},
{"~A BX LR" ,4, 0xb87e9c+4,false},--双倍金币
{"~A MOV	 R0, #1" ,4, 0x18fe544,false},
{"~A BX LR" ,4, 0x18fe544+4,false},--头像框
{"~A MOV	 R0, #1" ,4, 0xc21518,false},
{"~A BX LR" ,4, 0xc21518+4,false},--奖杯领取
{"~A MOV	 R0, #1" ,4, 0xbb30f0,false},
{"~A BX LR" ,4, 0xbb30f0+4,false},--人物
{"~A MOV	 R0, #1" ,4, 0xbb40f4,false},
{"~A BX LR" ,4, 0xbb40f4+4,false},--滑板
{"~A MOV	 R0, #1" ,4, 0xbde764,false},
{"~A BX LR" ,4, 0xbde764+4,false},--背
{"~A MOV	 R0, #1" ,4, 0xbb48dc,false},
{"~A BX LR" ,4, 0xbb48dc+4,false},--背[保]
...
function()
SO_PT(0xbb30f0 ,4,"~A MOVW  R0, #1")
toMusic('TINY己为您开启人物全解')
end},{"滑板全解",
function()
SO_PT(0xbb40f4 ,4,"~A MOVW  R0, #1")
toMusic('TINY己为您开启滑板全解')
end},{"背饰全解",
function()
SO_PT(0xbde764 ,4,"~A MOV  R0, #1")
SO_PT(0xbb48dc ,4,"~A MOV  R0, #1")---背饰保存
toMusic('TINY己为您开启背饰全解')
end},{"像框全解",
function()
SO_PT(0x18fe544 ,4,"~A MOVW R0, #1")
string.toMusic("TINY己为您开启头像框全解")
end},{"角色装扮",
function()
SO_PT(0xba52ac ,4,"~A MOVW  R0, #1")
		string.toMusic("TINY己为您开启角色装扮全解")
end},{"滑板技能",
function()
SO_PT(0xd261d0 ,4,"~A MOVW  R0, #1")
string.toMusic("TINY己为您开启滑板技能全解")
end},{"超长名字",
function()
SO_PT(0x1096b80 ,4,"~A B +0x148")
string.toMusic("TINY己为您开启超长名")
end},{"十倍得分",
function()
SO_PT(0x2cfaf40 ,4,"~A MOVW R0, #1")
...
{"破解内购",
function()
SO_PT(0x1a0bfd4 ,4,"~A B "..SOGSPY_ST(0x1a0bfd4 ,0x1a1ce60))
...
gg.alert('️TINY己为您开启奖杯')
end},{"一键领奖",
function()
SO_PT(0xc21518 ,4,"~A MOVW  R0, #1")
...
gg.addListItems({{address = ttt+0x4, flags = 4, value = 0, freeze = true}})
gg.addListItems({{address = ttt, flags = 4, value = YX, freeze = true}})
gg.alert('️TINY己为您开启赛季币\n请到兑换界面查看')
end},{"金币人物",
function()
SO_PT(0x1240d78 ,4,"~A MOVW R0, #1")
string.toMusic("TINY己为您开启人物货币")
end},{"金币滑板",
function()
SO_PT(0x12412cc ,4,"~A MOVW R0, #1")
string.toMusic("TINY己为您开启滑板货币")
end},{"金币背饰",
function()
SO_PT(0x1241834 ,4,"~A MOVW R0, #1")
string.toMusic("TINY己为您开启背饰货币")
end},}),
}),
changan.box({"宝物箱子",
changan.check({
{"十抽半宝",
function()
SO_PT(0x1087c60 ,4,"~A B "..SOGSPY_ST(0x1087c60 ,0x108a12c))
string.toMusic("TINY己为您开启十抽一级宝物请前往宝物箱子界面进行十抽")
end},{"十抽宝物",
function()
SO_PT(0x1087c60 ,4,"~A B +0x1930")
string.toMusic("TINY己为您开启十抽全宝物请前往宝物箱子界面进行十抽")
end},{"十抽全饰",
function()
SO_PT(0x1087c60 ,4,"~A B "..SOGSPY_ST(0x1087c60 ,0xbb3960))
string.toMusic("TINY己为您开启十抽全饰请前往宝物箱子界面进行十抽")
end},{"十抽半饰",
function()
SO_PT(0x1087c60 ,4,"~A B "..SOGSPY_ST(0x1087c60 ,0xbb4d30))
...
"替换人物",
function()
Sy_x32(0x1118adc,"~A MOV R0, #10")
Sy_x32(0x1118c90,"~A MOV R0, #"..gg.prompt({"请输入人物代码保安是190"},{"190"},{"text"})[1])
...
"替换滑板",
function()
Sy_x32(0x1118adc,"~A MOV	 R0, #12")
Sy_x32(0x1118e44,"~A MOV  R0, #"..gg.prompt({"请输入滑板代码跑车是60"},{"60"},{"text"})[1])
end,
function()
...
"替换背饰",
function()
Sy_x32(0x1118adc,"~A MOV R0, #14")
Sy_x32(0x1118ff8,"~A MOV R0, #"..gg.prompt({"请输入背饰代码磁铁是22"},{"22"},{"text"})[1])
...
"替换奖杯",
function()
Sy_x32(0x1118adc,"~A MOVW R0, #25")
string.toMusic('TINY己为您开启奖励替换为奖杯')
end,
function()
...
changan.button("确认更改",
function()
Sy_x32(0x1118adc,"~A MOVW R0, #"..changan.getedit("自定义锁定"))
...
So_32(0xb9d484,"~A MOVW R0, #"..num_3,false)
So_32(0xb9d484+4,"~A MOVT R0, #"..num_2)
elseif(Key==2 and value ~="")then
local num_1 = changan.getedit("普通钥匙数量")
local num_1 = tonumber(num_1)
local num_2 = num_1 / 65536
local num_3 = num_1 -65536 * num_2
So_32(0xb9d830,"~A MOVW R0, #"..num_3,false)
So_32(0xb9d830+4,"~A MOVT R0, #"..num_2)
elseif(Key==3 and value ~="")then
local num_1 = changan.getedit("宝物钥匙数量")
local num_1 = tonumber(num_1)
local num_2 = num_1 / 65536
local num_3 = num_1 -65536 * num_2
So_32(0xbe704c,"~A MOVW R0, #"..num_3,false)
So_32(0xbe704c+4,"~A MOVT R0, #"..num_2)
elseif(Key==4 and value ~="")then
SO_PT(0xbe0534 ,4,"~A MOVW	 R0, #"..changan.getedit("燃跑炫卡等级"))
...
local num_2 = num_1 / 65536
local num_3 = num_1 -65536 * num_2
So_32(0xbd6370,"~A MOVW R0, #"..num_3,false)
So_32(0xbd6370+4,"~A MOVT R0, #"..num_2)
elseif(Key==7 and value ~="")then
local num_1 = changan.getedit("账号当前等级")
local num_1 = tonumber(num_1)
local num_2 = num_1 / 65536
local num_3 = num_1 -65536 * num_2
So_32(0xba133c,"~A MOVW R0, #"..num_3,false)
So_32(0xba133c+4,"~A MOVT R0, #"..num_2)
elseif(Key==8 and value ~="")then
SO_PT(0xdf13ac ,4,"~A MOVW R0, #"..changan.getedit("道赛显示全服"))
...
YX = gg.prompt({"简介:\n省地区代码0=其他地区\n1=北京\n2=上海\n3=天津\n4=重庆\n5=河北\n6=山西\n7=河南\n8=辽宁\n9=吉林\n10=黑龙江\n11=内蒙古\n12=江苏\n13=山东\n14=安徽\n15=浙江\n16=福建\n17=湖北\n18=湖南\n19=广东\n20=广西\n21=江西\n22=四川\n23=海南\n24=贵州\n25=云南\n26=西藏\n27=陕西\n28=甘肃\n29=青海\n30=宁夏\n31=新疆\n32=香港\n33=澳门\n34=台湾,排名代码1~100\n排名:","省地区:"},{"1"},{"1"})
if not YX then return end
SO_PT(0xdf1454 ,4,"~A MOVW	 R0, #"..YX[1].."")--省服
SO_PT(0xdf14fc ,4,"~A MOVW	 R0, #"..YX[2].."")--省服地区
string.toMusic("TINY己为您开启全省排名")  
end),
changan.switch("防至道具" ,
function()
SO_PT(0x1566ccc ,4,"~A MOVW R0, #1")
gg.alert("TINY己为您开启防道具请佩戴耳机使用")
end,
				function ()
SO_ST(0x1566ccc,"F04F2DE9r","1CB08DE2r")
gg.alert("防道具关闭成功")
				end),
changan.switch("无视道具[部分]" ,
function()
SO_PT(0x1b110d0 ,4,"~A MOV R0, #2")
string.toMusic("TINY己为您开启无视道具")
end),
changan.switch("无视道具[所有]" ,
function()
SO_PT(0x1cec484 ,4,"~A MOV R0, #1")
string.toMusic("TINY己为您开启无视道具")
end),
changan.switch("无视障碍" ,
function()
SO_PT(0x1d7a904 ,4,"~A MOV R0, #1")
...
if not YX then return end
SO_PT(0xb9cbc4 ,4,"~A MOVW R0, #"..YX.."")
string.toMusic("开局道具")
end),
changan.switch("能量穿透" ,
function()
SO_PT(0x1ce3868 ,4,"~A MOV R0, #0")
SO_PT(0x1ce4658 ,4,"~A MOV R0, #0")
string.toMusic("TINY己为您开启能量穿透")
end,
function ()
SO_PT(0x1ce3868 ,4,"~A MOV R0, #1")
SO_PT(0x1ce4658 ,4,"~A MOV R0, #1")
gg.alert('️关闭成功')
end),
changan.switch("无宝聚能[重力]" ,
function()
SO_PT(0x1ce6d6c ,4,"~A B "..SOGSPY_ST(0x1ce6d6c ,0x1ce8758))
string.toMusic("无宝聚能成功")
end,
function ()
SO_ST(0x1ce6d6c ,"F0482DE9r","10B08DE2r")
gg.alert('️关闭成功')
end),
changan.switch("无宝聚能[非重力]" ,
function()
SO_PT(0x1ce7aa0 ,4,"~A B "..SOGSPY_ST(0x1ce7aa0 ,0x1ce8758))
string.toMusic("无宝聚能成功")
end,
function ()
SO_ST(0x1ce7aa0 ,"F0482DE9r","10B08DE2r")
gg.alert('️关闭成功')
end),
changan.switch("无限能量[非重力]" ,
function()
gg.alert('️建议搭配能量穿透')
SO_PT(0x1ce8918 ,4,"~A B "..SOGSPY_ST(0x1ce8918 ,0x1ce8758))
string.toMusic("TINY己为您开启无限能量")
end,
function ()
SO_ST(0x1ce8918 ,"F0482DE9r","10B08DE2r")
gg.alert('️关闭成功')
end),
changan.switch("时间聚能" ,
function()
...
changan.switch("分数成倍",
function()
SO_PT(0xba2af0 ,4,"~A MOVW R0, #"..gg.prompt({"注:不可过大"},{""},{"number"})[1])
...
changan.switch("滑板滑翔",
function()
SO_PT(0x1dd80a8 ,4,"~A MOVW R0, #1")
string.toMusic("滑板滑翔开起成功")
end,
function()
SO_PT(0x1dd80a8 ,4,"~A MOVW R0, #0") 
string.toMusic("滑板滑翔关闭成功")
end),
changan.switch("滑板瞬移",
function()
SO_PT(0x1dd8218 ,4,"~A MOVW R0, #1")
string.toMusic("滑板瞬移开起成功")
end,
function()
SO_PT(0x1dd8218 ,4,"~A MOVW R0, #0") 
...
changan.switch("滑板高跳",
function()
SO_PT(0x1dd7cc8 ,4,"~A MOVW R0, #1")
string.toMusic("滑板高跳开起成功")
end,
function()
SO_PT(0x1dd7cc8 ,4,"~A MOVW R0, #0") 
string.toMusic("滑板高跳关闭成功")
end),
changan.switch("无限跳跃",
function()
SO_PT(0x1ab9608 ,4,"~A MOVW R0, #1")
string.toMusic("无限跳跃开起成功")
end,
function()
SO_PT(0x1ab9608 ,4,"~A MOVW R0, #0")
string.toMusic("无限跳跃关闭成功") 
end),
changan.switch("无尽不死",
function()
SO_PT(0x2b54760, 4, "~A MOVWR0, #1")
