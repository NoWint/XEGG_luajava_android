...
_ENV["jm"..当前ui]:setBackground(getVerticalBG({0x00000000,0x00000000},15))--选中后颜色
 ...
 --     background=getCorner({0xffffffff,0xffffffff},15,0,0xff232323,45,0,0,0),
  ...
  ckou = {
	...
	Yunzhu.text("Powered By 云烛",主题色[2],"10sp",true),
...
gg.alert('防止高检开启成功')		
		...
		Yunzhu.box({"TINY大厅防御",
		Yunzhu.seek("Yunzhu","lt",1,100,1),--名字，变量名字，最小，最大，初始
	Yunzhu.switch("框架环境[登录]",
		function()
...
firadio = {
  ...
  --background = luajava.loadlayout{GradientDrawable,color=0xffffffff,cornerRadius=20},
    LayoutTransition=layoutTransition,
    onClick = function() visi2 (tid , ttid) 
    end
}
if type (views [1]) == "string" or type (views [1]) == "number" then
firadio [# firadio + 1] = {
...
function Yunzhu.ThemeGreen()
主题色={"0xff96D5A7","0xff96D5A7","0xff1C211C","0xff101510"}
主题色sli="96D5A7"
主题switin="0xff313631"
end
function Yunzhu.ThemeWhiteHarmony()
主题色={"0xff004eff","0xff004eff","0xfff2f3f5","0xffffffff"}
主题色sli="004eff"
主题switin="0xff32353a"
end
function Yunzhu.ThemeDarkWechat()
主题色={"0xff07C160","0xff07C160","0xff1E1E1E","0xff111111"}
主题色sli="07C160"
主题switin="0xff252525"
end
function Yunzhu.ThemeDarkBlue()
主题色={"0xff004eff","0xff004eff","0xff1E1E1E","0xff111111"}
主题色sli="004eff"
主题switin="0xff252525"
end
function Yunzhu.ThemeDarkRed()
主题色={"0xffff0000","0xffff0000","0xff1E1E1E","0xff111111"}
主题色sli="ff0000"
主题switin="0xff252525"
end
---↑改色配置↑---
...
--Yunzhu.ThemeBlue()
--Yunzhu.ThemeGreen()
--Yunzhu.ThemeWhiteHarmony()
--Yunzhu.ThemeDarkWechat()
--Yunzhu.ThemeDarkBlue()
Yunzhu.ThemeDarkRed()
