...
zdfhjmk=gg.prompt({"进入VAPE主界面","进入自动防环境\n[1.自动选择进程]\n[2.自动刷新模块]\n[3.自动执行防环境]\n[4.完成以上操作后进入VAPE主界面]"}, nil, {"checkbox","checkbox"})
if zdfhjmk == nil then 
gg.alert('欢迎老板使用VAPE为老板保驾护航')
string.toMusic('欢迎老板使用VAPE为老板保驾护航')
...
创建页面('防封',
	{
	changan.text("VAPE全防","#ffffff","20sp"),
	changan.button("选择进程",
function ()
gg.setConfig("冻结间隔", 0)
...
第一页 = {--创建分页，结尾调用
	...
	[1]={--第一分区
		['分区名字']="公告",
		['功能配置']={
			changan.text("VAPE v4","#ffffff","22sp"),
changan.text("VAPE通知群:923441198","#ffffff","17sp"),
changan.text("VAPE在新赛季带你杀出重围","#ffffff","18sp"),
changan.button("选择进程",
function ()
gg.setConfig("冻结间隔", 0)
string.toMusic('请选择地铁跑酷进程')
...
第二页 = {
	...
	[1]={--第一分区
		...
		['功能配置']={
			...
			changan.text("VAPE内部","#ffffff","20sp"),
changan.text("VAPE通知群:923441198","#ffffff","17sp"),
changan.box({"API功能",
changan.button("注意事项",
function()
...
string.toMusic("VAPE己为您开启十抽一级宝物请前往宝物箱子界面进行十抽")
end},{"十抽宝物",
function()
SO_PT(17333552, 4, "~AB +0x1930") 
string.toMusic("VAPE己为您开启十抽全宝物请前往宝物箱子界面进行十抽")
end},{"十抽全饰",
function()
SO_PT(12221104, 4, "~AB -0x4E0280") 
string.toMusic("VAPE己为您开启十抽全饰请前往宝物箱子界面进行十抽")
end},{"十抽半饰",
function()
SO_PT(12226176, 4, "~AB -0x4DEEB0")
string.toMusic("VAPE己为您开启十抽半饰请前往宝物箱子界面进行十抽")
end},{"十抽保存",
function()
SO_PT(17325800, 4, "~AB +0x1E48")
string.toMusic("VAPE己为您开启十抽宝物备份请前往保护箱子界面进行十抽")
end
}
}),
}),
...
string.toMusic('VAPE己为您开启奖励替换为人物')
end,
function()
...
string.toMusic('VAPE己为您开启奖励替换为背饰')
end,
function()
...
string.toMusic('VAPE己为您开启奖励替换为头像框')
end,
function()
...
string.toMusic('VAPE己为您开启奖励替换为金币')
end,
function()
...
string.toMusic('VAPE己为您开启奖励替换为蓝色钥匙')
end,
function()
...
string.toMusic("VAPE己为您调出挂杯请前往道具赛查看")
end,
function()
end}, 
{"备份数据" ,
...
string.toMusic("VAPE己为您开启双倍金币获取请前往主页查看")
end,
function()
end},
{"微博特权",
...
string.toMusic("VAPE己为您开启微博特权获取请前往主页查看")
end},
{"历史分数",
function() 
SO_PT(0xb9e0c4 ,4,"~A MOVT	 R0, #20000")
SO_PT(0xb9de70 ,4,"~A MOVT	 R0, #20000")
string.toMusic("VAPE己为您开启历史分数")
end},
}),	
}),
...
gg.alert("VAPE提醒您断网状态开启成功")
end,
				function ()
SO_PT(0x2b04764, 4, "~A MOVW  R0, #0")
gg.alert("VAPE提醒你断网状态恢复成功")
				end),
changan.button("隐藏数据" ,
function()
...
gg.alert(os.date'️VAPE己为您开启隐藏信息,可预防MK查看跑号') 
string.toMusic('VAPE己为您开启隐藏信息，可预防MK查看跑号')	
end),
changan.box({"冲榜功能",
changan.switch("一能一板" ,
function()
SO_PT(30287564, 4, "~AB +0x140C")  
gg.alert("VAPE己为您开启自动开板")
end,
				function ()
				end),
changan.switch("滑动聚能" ,
...
string.toMusic("VAPE己为您开启全省排名")  
end),
changan.switch("防至道具" ,
function()
SO_PT(0x1e7ac44, 4, "~A MOVW  R0, #1")
gg.alert("VAPE己为您开启防道具请佩戴耳机使用")
end,
				function ()
...
ms.edit( 1.1 , 0x60 , 16 )
ms.edit( 3 , 0x4C , 4 )
string.toMusic("VAPE己为您开启折扇一秒一能量")
end),
			}) ,
		}
	},
