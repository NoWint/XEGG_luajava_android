...
gggscro=luajava.loadlayout
							...
							{
								TextView,
								text = string.fromHtml(getTimeStamp(os.time()).." <font color=#FFFFFF>".."𝐓𝐈𝐍𝐘 𝐏𝐫𝐨 Ꮯꮋꭼꭺꭲꮪ\n 𝐐𝐐 𝐆𝐫𝐨𝐮𝐩 𝟖𝟏𝟖𝟗𝟔𝟑𝟗𝟗𝟖".."</font>"),
								textSize = "12sp",
								textColor = color,
								gravity="left",
								layout_width = "wrap_content",
...
slcta = getShape(
	15,
	{
	0xe8905AFF,0x68905aff,0x68ff4358
},
	0,0x01B8B8B8)
...
---侧边标题和图标
	{
		"阿波罗_防封","@android:drawable/ic_dialog_map.png"
	},
	{
		"阿波罗_刷号","@android:drawable/ic_dialog_email"
	},
	{
		"阿波罗_竞赛","@android:drawable/ic_search_category_default"
	},
	{
		"阿波罗_社团","@android:drawable/ic_popup_sync"
	},
	{
		"阿波罗_音乐","@android:drawable/ic_popup_reminder"
	},
	{
		"阿波罗_设定","@android:drawable/stat_sys_data_bluetooth"
	},
