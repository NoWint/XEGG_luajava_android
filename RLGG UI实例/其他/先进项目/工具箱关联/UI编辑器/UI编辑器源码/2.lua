...
--	Yunzhu.text("  ⊕\n",'0xffffffff',"38sp",true),
	Yunzhu.text("云烛 UI工具箱",'0xffffffff',"18sp",true),
	Yunzhu.text("这是一个基于RLGG material design style的Luajava UI工具箱。提供大量免费/付费独家UI",'0xffffffff',"13sp",true),
	}),
	Yunzhu.quyuBasic({
	"0xffEADDFF",
--	Yunzhu.text("  ⊕\n",'0xffffffff',"38sp",true),
		Yunzhu.text("这是什么？",'0xff21005D',"18sp",true),
	Yunzhu.text("云烛UI工具箱 涵盖UI编辑器 UI下载 聊天室 免费音乐播放等为一体 ",'0xff21005D',"13sp",true),	
	}),
...
luajava.showAlert(dialogBuilder)						
	...
	onClick = function() 
			luajava.newThread(function() 切换("主页")  end):start() end,
