...
public class 菜单功能 extends LinearLayout {
    ...
    private void init(Context mContext) {
        ...
        final Button 菜单一 = Packaging.Button("功能菜单", "菜单一.png", 配置.buttonParams);
        菜单栏.addView(菜单一);

        final Button 菜单二 = Packaging.Button("菜单二", "菜单二.png", 配置.buttonParams);
        菜单栏.addView(菜单二);

        final Button 菜单三 = Packaging.Button("菜单三", "菜单三.png", 配置.buttonParams);
        菜单栏.addView(菜单三);

        final Button 菜单四 = Packaging.Button("菜单四", "菜单四.png", 配置.buttonParams);
        菜单栏.addView(菜单四);

        final Button 菜单五 = Packaging.Button("菜单设置", "菜单五.png", 配置.buttonParams);
        菜单栏.addView(菜单五);
