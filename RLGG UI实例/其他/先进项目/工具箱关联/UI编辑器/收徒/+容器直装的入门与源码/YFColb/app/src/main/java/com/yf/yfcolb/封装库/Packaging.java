...
public class Packaging {
    ...
    public static void Switch(LinearLayout 绑定试图, String 文字, int 文字大小, int 文字颜色, SwitchStatusListener listener) {
        ...
        TextView featureText = new TextView(mContext);
    ...
    public static void 滑动(LinearLayout 绑定布局, final String 文本, final int 颜色, final String 文件名, final String 内容, int 最小值, int 最大值) {
        ...
        try {
            InputStream inputStream = mContext.getAssets().open("拖动条.png");
