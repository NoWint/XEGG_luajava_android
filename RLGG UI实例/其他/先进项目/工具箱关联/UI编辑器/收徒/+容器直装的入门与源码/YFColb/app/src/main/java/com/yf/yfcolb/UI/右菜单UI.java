...
public class 右菜单UI extends LinearLayout {
    ...
    private void init(Context mContext) {
        ...
        vLinearLayout 按钮功能 = Packaging.Button(
                //普通按钮属性配置🛠️
                右功能1,
        ...
        vLinearLayout 按钮一 = Packaging.Button(
                //普通按钮属性配置🛠️
                右功能1,
        ...
        vLinearLayout 按钮二 = Packaging.Button(
                //普通按钮属性配置🛠️
                右功能1,
        ...
        vLinearLayout 按钮三 = Packaging.Button(
                //普通按钮属性配置🛠️
                右功能1,
        ...
        vLinearLayout 按钮四 = Packaging.Button(
                //普通按钮属性配置🛠️
                右功能1,
