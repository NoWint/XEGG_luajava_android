...
public class TView extends LinearLayout{
    ...
    public TView TViewHSV(LinearLayout view,Object W,Object H,Object color,Object round,OnClickListener click){
        ...
        SV.setBackground(local.roundBG(color, round,"TB", 0));
        SV.setVerticalScrollBarEnabled(false);
        TView TGUI1s=new TView(getContext()).gravity("CT").WH(-1,-1).setBgD(color,round,"TB",0).ori(0).onClick(click);
        SV.addView(TGUI1s);
        return TGUI1s;
    }
    /*帧布局*/
