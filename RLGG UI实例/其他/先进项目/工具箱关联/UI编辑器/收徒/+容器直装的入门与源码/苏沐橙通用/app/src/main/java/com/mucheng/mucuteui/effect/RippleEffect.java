...
public final class RippleEffect {
  ...
  public static ComponentEventBus<PopupComponents.PopupContainer> Ripple(RippleProps pProps) {
  ...
  public static ComponentEventBus<PopupComponents.PopupContainer> Ripple() {
    return Ripple(null);
  }
