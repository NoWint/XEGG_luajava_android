...
public final class ScrollComponents {
  ...
  public static ComponentEventBus<HorizontalScrollView> RowScroll(ColumnScrollProps props) {
    final HorizontalScrollView scrollView = new HorizontalScrollView(requireActivity());
    scrollView.setOverScrollMode(View.OVER_SCROLL_NEVER);
    scrollView.setVerticalScrollBarEnabled(false);
    scrollView.setHorizontalScrollBarEnabled(false);

    final ComponentEventBus<HorizontalScrollView> eventBus = new ComponentEventBus<>(scrollView);
