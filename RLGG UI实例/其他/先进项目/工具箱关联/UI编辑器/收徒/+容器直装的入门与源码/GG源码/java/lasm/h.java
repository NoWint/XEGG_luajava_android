...
public class h {
    ...
    public h(Reader reader, int i, int i2, int i3) {
        this.d = -1;
        this.g = 0;
        this.h = 1;
        this.i = false;
    ...
    public h(InputStream inputStream, String str, int i, int i2, int i3) {
        this(str == null ? new InputStreamReader(inputStream) : new InputStreamReader(inputStream, str), i, i2, i3);
    }

    public h(InputStream inputStream, String str, int i, int i2) {
    ...
    public String h() {
        ...
        return String.valueOf(new String(this.l, this.c, this.a - this.c)) + new String(this.l, 0, this.d + 1);
    }
}
