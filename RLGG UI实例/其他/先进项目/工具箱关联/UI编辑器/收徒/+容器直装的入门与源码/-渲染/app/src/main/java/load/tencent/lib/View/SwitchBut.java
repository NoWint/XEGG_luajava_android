...
public class SwitchBut{
    ...
    public SwitchBut(Context ct,LinearLayout v,boolean b,String title,String detailed,NewSwitch.OnSwitchStateChangeListener on){
        context=ct;
        NewView sbl=new NewView(context, (int)(W() * 0.45), (int)(H() * 0.13), "LC", 0, 1, "#FFFFFF", 20, null);
        sbl.setElevation(8);
        ...
        NewView sbl5=new NewView(context, (int)(W() * 0.08), (int)(H() * 0.13), "CC", 0, 2, null,null, null);
        NewSwitch sw=new NewSwitch(ct);
        sw.setOn(b);
        sw.setOnSwitchStateChangeListener(on);
		sw.setLayoutParams(new ViewGroup.LayoutParams((int)(W() * 0.1), (int)(H() * 0.14)));
        sw.setbackgroundColor(Color.parseColor("#FFFFFF"));
        sw.setcolorStep(Color.parseColor("#FFFFFF"));
        sbl5.setElevation(8);
