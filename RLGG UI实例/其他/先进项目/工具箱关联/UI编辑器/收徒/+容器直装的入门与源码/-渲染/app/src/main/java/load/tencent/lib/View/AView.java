...
public class AView extends LinearLayout {
        ...
        public AView(Context context, LinearLayout view, Object sizeW, Object sizeH, String gravity, Object ori, int cm, Object color, Object cr, final OnClickListener set) {
                super(context);
        ...
        private static void setSizeWH(Object sizeW, Object sizeH, LinearLayout v) {
                if (sizeW != null && sizeH != null) {
                        v.setLayoutParams(new LayoutParams((int)(sizeW), (int)(sizeH)));
                    }
            }
