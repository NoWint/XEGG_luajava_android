...
public class Menu {
	...
	public void showIcon() {
		...
		if (!isIconVisible)
		{
			...
			parentBox.addView(iconView, dpi(40),dpi(40));
			isIconVisible = true;
		}
	}
	...
	public void addLinkButton(int pageid, String text, String link) {
		...
		GradientDrawable grad = new GradientDrawable();
		grad.setColor(Color.parseColor("#01579b"));
		grad.setCornerRadius(20f);
	...
	public void addSlider(int pageid, int featureid, String text, int min, int max, int progress, final callbackSlider callback) {
		...
		slider.getProgressDrawable().setColorFilter(Color.parseColor("#01579b"), PorterDuff.Mode.MULTIPLY);
        slider.getThumb().setColorFilter(Color.parseColor("#01579b"), PorterDuff.Mode.MULTIPLY);
	...
	public void addPage(String name, String icon, int pageId) {
		...
		GradientDrawable pgrad = new GradientDrawable();
            pgrad.setColor(Color.parseColor("#01579B"));
		page.setBackgroundDrawable(pgrad);
		pgrad.setCornerRadius(20f);
		line.addView(page);
	...
	public void addTextPage(int pageid, int featureid, String text) {
		...
		GradientDrawable grad = new GradientDrawable();
		grad.setColor(Color.parseColor("#002F55"));
		grad.setCornerRadius(20f);
		textView.setPadding(0, 0, 0, 0);
	...
	public Menu(Context context) {
		...
		try {
			...
			grad2.setCornerRadius(20f);
			grad2.setStroke(3, Color.parseColor("#26252A"));
			grad2.setColor(Color.parseColor("#01579B"));
			...
			*/
			...
			grad3.setCornerRadius(10f);
			grad3.setStroke(3, Color.parseColor("#01579b"));
			...
			iconP.rightMargin = 5;
			rightLayout.addView(headerLayout, -1, dpi(35));
			LinearLayout purpleHead = new LinearLayout(context);
			purpleHead.setBackgroundColor(Color.parseColor("#01579b"));
			...
			GradientDrawable gjmh1 = new GradientDrawable();
			rightLayout.addView(rightUp, -1, -1);
			rightUp.setPadding(15, 15, 15, 15);
			gjmh1.setStroke(3, Color.parseColor("#01579b"));
			rightUp.setBackgroundDrawable(gjmh1);
			...
			grad4.setCornerRadius(5f);
			grad4.setStroke(3, Color.parseColor("#01579b"));
			pages.setBackgroundDrawable(grad4);
			pages.setElevation(5f);
			pages.setPadding(15,15,15,15);
