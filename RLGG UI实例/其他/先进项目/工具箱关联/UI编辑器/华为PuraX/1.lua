...
function 获取图片3(txt)
    ...
    if file.length("/sdcard/云烛/图片/"..ntxt,false)<200 then
...
--  SearchProgress:setTrackColor(0x16161616)  
  ...
  menuView= luajava.loadlayout {
    FrameLayout,
    --background={GradientDrawable,color=0xFFF3EDF7,cornerRadius=50},
    background={
    imageView,
  background=  "/storage/emulated/0/云烛/图片/HuaweiPuraX.png",
  },
    layout_width="match_parent",
    layout_height="match_parent",
    {
    ...
    background={GradientDrawable,color=0xFFFEF7FF,cornerRadius=50},
    elevation="5dp",
...
firadio = {
    ...
    gravity = "center",
    orientation = "vertical",
   background=getHorizontalBG({0xFFF3EDF7,0xFFF3EDF7},40,3,0xff49454F),
   elevation="2dp",
    LayoutTransition=layoutTransition,
...
function Yunzhu.box(views)
  ...
  firadio={
    LinearLayout,
    layout_width='match_parent',
    background=luajava.loadlayout{GradientDrawable,color=0xFFFFFFFF,cornerRadius=50},
    elevation="3dp",
    layout_height="wrap_content",
    layout_margin="4dp",
    orientation="vertical",
