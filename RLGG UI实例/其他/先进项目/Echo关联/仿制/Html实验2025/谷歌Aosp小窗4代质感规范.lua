...
local FontPath = "/storage/emulated/0/云烛/图片/font.ttf"--字体路径
...
<body>
    <div class="dynamic-island" id="dynamicIsland">
        <div class="music-container">
            ...
            <div class="song-info">
                <div class="song-title">YunzhuMusic</div>
                <div class="artist">HTMLUI</div>
            </div>
    ...
    <div class="close-area" id="closeArea"></div>
