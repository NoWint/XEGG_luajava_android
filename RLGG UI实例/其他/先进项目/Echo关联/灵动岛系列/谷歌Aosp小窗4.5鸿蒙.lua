...
local FontPath = "/storage/emulated/0/云烛/配置文件/sunsans-regular.ttf"--字体路径
  ...
  if 缩放 then
    ...
    if Action == MotionEvent.ACTION_DOWN then
      ...
      if x==0 or x==-2 then x=1700 y=1300 end
        ckou:setBackground(getVerticalBG({主题色[4],主题色[4]},45,5,主题色[1]))     
   --  Blur(ckou, 20)
     elseif Action == MotionEvent.ACTION_MOVE then
      isMove = true
     ...
     elseif event:getAction() == MotionEvent.ACTION_UP then
      ckou:setBackground(getVerticalBG({主题色[4],主题色[4]},45,0,0xaa232323))
    end
    window:updateViewLayout(floatWindow, mainLayoutParams)
  end
end
...
_ENV["jm"..当前ui]:setBackground(getVerticalBG({0x00000000,0x00000000},15))--选中后颜色
 ...
 --     background=getCorner({0xffffffff,0xffffffff},15,0,0xff232323,45,0,0,0),
  ...
  ckou = {
    ...
    layout_height = "match_parent",
    orientation = "vertical",
    background = getVerticalBG({主题色[4],主题色[4]},45),
    topbar,
...
Yunzhu.box({
	"普通分页",
	Yunzhu.switch("开关123456",function() gg.alert("开") end,function() gg.alert("关") end),
	Yunzhu.switch("开关123456",function() gg.alert("开") end,function() gg.alert("关") end),
	Yunzhu.switch("开关",function() gg.alert("开") end,function() gg.alert("关") end),
	Yunzhu.switch("开关",function() gg.alert("开") end,function() gg.alert("关") end),
	}),
Yunzhu.box({
  ...
  --以下为底部灵动岛
  {
	...
	Yunzhu.lddboxBT({
	"                            ",
	Yunzhu.text("  卡片弹窗",主题色[2],"13sp"),
	Yunzhu.text("  Powered By 云烛","0xffffffff","10sp"),
...
function Yunzhu.ThemeDarkPurple()
主题色={"0xff6750A4","0xff6750A4","0xff1E1E1E","0xff111111"}
主题色sli="6750A4"
主题switin="0xff252525"
end
---↑改色配置↑---
...
--Yunzhu.ThemeDarkRed()
Yunzhu.ThemeDarkPurple()
灵动岛标题="TinyStudio GhostClient"
...
Yunzhu.menu(
{
  ...
  Yunzhu.text("QQ群827953713",主题色[2],"10sp",true),
  Yunzhu.lddbox({
