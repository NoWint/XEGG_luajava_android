...
function Yunzhu.menu(sview)
  ...
  floatWindow=luajava.loadlayout{
    ...
    {
      MaterialCardView,
      background={GradientDrawable,color=0xff161616,cornerRadius=20},
      layout_width="match_parent",
...
return jianbians
  ...
  function seeColor()
    luajava.startThread(function()
      luajava.runUiThread(function()
        ...
        luajava.getIdView("tab2"):setTabTextColors(0xffffffff,"0xff"..RGBcolor)
    ...
    orientation="vertical",
    {
      ...
      },
      {
        ...
        },
        {
          ...
          layout_height="match_parent",
          layout_marginRight="10dp",
          background=luajava.loadlayout{GradientDrawable,color=0xff161616,cornerRadius=15},
          layout_width="match_parent",
          layout_weight=2,
  ...
  function 修改控件颜色(color)
    luajava.runOnUiThread(function()
      tab:setTabTextColors(0xffffffff,"0xff"..RGBcolor)
  ...
  menuView= luajava.loadlayout {
    ...
    layout_height="match_parent",
    {
      ...
      orientation="vertical",
      {
        ...
        layout_height="35dp",
        elevation="3dp",
        background=getCorner({0xff161616,0xff161616},15,0,0xff232323,20,20,0,0),
        {
          FrameLayout,
...
"守护进程标题",
		...
		Yunzhu.text("   设定 Settings  ",switch颜色,"19sp"),
  ...
  return{
   ...
   --   thumbIconDrawable=SwitchDrawable("xyopen","xyclose"),
     TrackTintList=ColorStateList({{android.R.attr.state_checked}},{0xFF0062FF}),
      ...
      thumbTintList=(ColorStateList({{android.R.attr.state_checked},{-android.R.attr.state_checked}},{0xff161616,0xFF4B484F})),      
...
function Yunzhu.text(text,color,size,isjz)
	...
	function getButtonBG()
		...
		selector:addState({
			-android.R.attr.state_pressed
		}, getVerticalBG({0xff161616,0xff161616},20))
		return selector
	end
...
function Yunzhu.box(views)
  ...
  firadio={
    LinearLayout,
    layout_width='fill_parent',
    background=luajava.loadlayout{GradientDrawable,color=0xff161616,cornerRadius=20},
    elevation="3dp",
    layout_height="wrap_content",
    layout_margin="4dp",
    orientation="vertical",
...
buts={}
	...
	function Yunzhu.buttonlink(txt,func,txtc)
		...
		layout_height = "wrap_content", {
			...
			layout_marginRight='3dp',
			elevation='2dp',
			background = getHorizontalBG({0xffff00cf,0xff5500ff},15,1,0xff161616),
			padding="10dp",
				onClick = function()
					Yunzhu.controlWater(buts[tid],300)
					luajava.newThread(func):start() end,
...
Yunzhu.menu({
  ...
  Yunzhu.quyu({        "YunzhuNB",
    Yunzhu.text(项目名字,'0xff161616',"25sp",true),
    Yunzhu.text("Powered By Yunzhu RebornLua",'0xff161616',"10sp",true),
    }),
    Yunzhu.quyu({
"",
Yunzhu.quyu({
...
Yunzhu.quyuM({
"",
Yunzhu.text("   通过链接电脑启动(使用 adb)",0xffffffff,"15sp"),
--Yunzhu.text("   \n",0xffffffff,"12sp"),
Yunzhu.text("   对于没有root的设备需要借助adb来启动Shizuku。这个过程每次设备重新启动时都需要重新进行。",0xffffffff,"9sp"),
Yunzhu.buttonM(
					"↺ 查看指令",
					function()
						local tmp=Yunzhu.getedit("输入框演示")
...
"",
Yunzhu.text("   启动(针对已root设备)",0xffffffff,"15sp"),
--Yunzhu.text("   \n",0xffffffff,"12sp"),
Yunzhu.text("   另外，Shizuku可以在开机时自动启动。如果没有，请检查您的系统或是第三方工具是否限制了Shizuku。",0xffffffff,"9sp"),
Yunzhu.buttonM(
					"▶ 启动",
					function()
						local tmp=Yunzhu.getedit("输入框演示")
