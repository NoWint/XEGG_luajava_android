...
function Yunzhu.menu(sview)
  ...
  floatWindow=luajava.loadlayout{
    ...
    {
      MaterialCardView,
      background={GradientDrawable,color=0xFF18120C,cornerRadius=20},
      layout_width="match_parent",
...
---菜单
  menuView= luajava.loadlayout {
    ...
    background={GradientDrawable,color=0xFF251E17,cornerRadius=00},
...
灵动岛公告='Powered By Yunzhu 滑动以进行交互'

Yunzhu.menu({
  {---第一页  
  Yunzhu.quyu({        "YunzhuNB",
    Yunzhu.text(项目名字,'0xfff4f4f4',"25sp",true),
    Yunzhu.text("Powered By Yunzhu RebornLua",'0xfff4f4f4',"10sp",true),
    }),
    Yunzhu.quyu({
"",
Yunzhu.quyu({
...
"标题",
		...
		Yunzhu.quyu({
		"",
		Yunzhu.text("   即刻购买静谧土星VIP 使用更多独家功能",0xfff4f4f4,"12sp"),		
		Yunzhu.buttonlink(
					"了解更多",
					function()
						local tmp=Yunzhu.getedit("输入框演示")
...
Yunzhu.text("   注意事项",0xffffffff,"19sp"),
		...
		Yunzhu.quyu({
		"",
		Yunzhu.text("   仅从官方 GitHub 页面下载 静谧土星",0xfff4f4f4,"12sp"),
