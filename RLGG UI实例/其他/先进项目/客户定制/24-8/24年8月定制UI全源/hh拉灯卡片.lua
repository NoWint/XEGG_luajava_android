...
parti=particle(
	...
	"rgba(255,255,255,1)",
	"#909090")
Yunzhu.controlFlip1 = function(control,time)
...
Yunzhu.controlFlip2 = function(control,time)
luajava.runUiThread(function()
	import "android.view.animation.Animation"
	import "android.animation.ObjectAnimator"
	xuanzhuandonghua = ObjectAnimator:ofFloat(control, "rotationY", {
...
luajava.runUiThread(function()
	...
	Yunzhu.controlBig(floatWindow,300)
	end
	end)
end
...
topbar = luajava.loadlayout({
	...
	layout_height="45dp",
	background=getCorner({0x78ffffff,0x78ffffff},15,0,0xff232323,60,60,60,60),
...
function proo()
Yunzhu.controlRotation2(control,2000)
end
function proo2()
Yunzhu.controlRotation2(control2,2000)
end
...
bglist = {
---背景图
getHorizontalBG({0xaaDA2C3E,0xaaFF9829},60),
	getVerticalBG({0xdd161616,0xdd161616},60),
	getHorizontalBG({0xaa116EFF,0xaaFF94C8},60),
	getHorizontalBG({0x8800D653,0xaa27A3FF},60),
	
	getHorizontalBG({0xaaA46FFF,0xaaFF7FD4},60),
	getHorizontalBG({0x55161616,0x55161616},60,5,0xffffffff),
	"https://escape2020-1303126286.cos.ap-shenzhen-fsi.myqcloud.com/sky",--比如这样是图片
