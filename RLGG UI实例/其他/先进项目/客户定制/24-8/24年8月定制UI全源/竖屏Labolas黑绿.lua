...
gggscro=luajava.loadlayout
							...
							{
								TextView,
								text = string.fromHtml(getTimeStamp(os.time()).." <font color=#FFFFFF>".."𝗟𝗔𝗕𝗢𝗟𝗔𝗦 Ꮯꮋꭼꭺꭲꮪ 𝐐𝐐 𝐆𝐫𝐨𝐮𝐩 𝟖𝟏𝟖𝟗𝟔𝟑𝟗𝟗𝟖".."</font>"),
								textSize = "12sp",
								textColor = color,
								gravity="left",
								layout_width = "wrap_content",
...
---侧边标题和图标
	{
		"Bypass","@android:drawable/ic_dialog_map.png"
	},
	{
