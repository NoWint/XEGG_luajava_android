...
function Yunzhu.menu(stitle,sview)
cebian = {
	LinearLayout,
...
mo_circle = luajava.loadlayout {
	...
	onTouch = hanshu,
	onClick = function()
		Yunzhu.controlRotation2(taiji,1000)
...
floatWindow = luajava.loadlayout(
	{
		...
		},
		{
			...
			id = "chuangk",
			elevation = "30dp",
	--	background = "https://cdn-community.codemao.cn/47/community/d2ViXzMwMDFfODE0MjY2NTE2XzBfMTcyMzAxNTAxOTA0NF9hMTdmZDMyZA.jpeg",
		--background=newbg2({0xdd161616,0xdd161616,0x99232323},0,0x00ffffff,25,25,25,25),
		background=getHorizontalBG({0x55161616,0x55161616},60,5,0xff121212),
			layout_height = "350dp",
			layout_width = "240dp",
			{LinearLayout,
id="webv_",
...
luajava.newThread(function()
	while true do
		if 显示==1 then
			Yunzhu.controlRotation2(taiji,2000)
			Yunzhu.controlRotation1(mo_circle,2000)
		end
			gg.sleep(2000)
	end
	end):start()
...
Yunzhu.controlRotation1 = function(control, time)
luajava.runUiThread(function()
	import "android.view.animation.Animation"
	import "android.animation.ObjectAnimator"
	xuanzhuandonghua = ObjectAnimator:ofFloat(control, "rotation", {
...
Yunzhu.controlRotation3 = function(control, to1,to2)
luajava.runUiThread(function()
	import "android.view.animation.Animation"
	import "android.animation.ObjectAnimator"
	xuanzhuandonghua = ObjectAnimator:ofFloat(control, "rotation", {
...
luajava.runUiThread (function ()
	...
	Yunzhu.controlWater (floatWindow , 300)
	end
	end
)
end
...
--_ENV["jmt"..i]:setText(stab[i].."")
	...
	Yunzhu.controlBig(_ENV["jm"..当前ui],100)
...
Yunzhu.controlRotation3(boxpic[tid],0,-90)
else
	tview : setVisibility (View.GONE)
Yunzhu.controlWater (_ENV [tid.."6"] , 200)
Yunzhu.controlRotation3(boxpic[tid],-90,0)
end
end
boxes = {} boxpic = {}
...
switches = {}
function Yunzhu.switch(name,func1,func2,yans)
nid = name..guid()
...
launchui = luajava.loadlayout({
	...
	layout_width = "match_parent",
	{
		...
		gravity="center",
		{
			...
			background = getShape0(90,0xff121212,0xff121212,0xff121212),
			layout_height = "25dp",
			layout_width = "55dp",
			layout_gravity="center_horizontal",
			...
			background = "https://cdn-community.codemao.cn/47/community/d2ViXzMwMDFfODE0MjY2NTE2XzBfMTcyMzAxNTAxOTA0NF9hMTdmZDMyZA.jpeg",
		{
			...
			onClick = function() 
			luajava.newThread(function() 切换(3)  end):start() end,
			background = getShape0(90,0xff121212,0xff121212,0xff121212),
			layout_height = "25dp",
			layout_width = "55dp",
			layout_gravity="center_horizontal",
		...
		gravity="center",
		{
			...
			onClick = function() 
			luajava.newThread(function() 切换(4)   end):start() end,
			background = getShape0(90,0xff121212,0xff121212,0xff121212),
			layout_height = "25dp",
			layout_width = "55dp",
			layout_gravity="center_horizontal",
		...
		
		{
			...
			onClick = function() 
			luajava.newThread(function() 切换(5)   end):start() end,
			background = getShape0(90,0xff121212,0xff121212,0xff121212),
			layout_height = "25dp",
			layout_width = "55dp",
			layout_gravity="center_horizontal",
...
Yunzhu.line(),
			Yunzhu.box ( {
				...
				Yunzhu.edit ("道具ID" , "锁捡道具ID") , ---输入框名字，输入框提示
				Yunzhu.button ("开启锁定" ,
					function ()
					sd = Yunzhu.getedit("道具ID")
					gg.alert(sd)--调用例子
					end) ,
			}) ,
			Yunzhu.box ( {
