...
h1{
    ...
    -webkit-text-match_parent-color: transparent;
    background-size: 80%;
...
slcta = getHorizontalBG({0xff4F378B,0xff4F378B},35)-----点时的翻页
			...
			{LinearLayout,
				...
				{LinearLayout,
					...
					{LinearLayout,
						...
						{
								TextView,
								text = string.fromHtml("<font color=#4F378B>".."欢迎使用HMplusUI","</font>"),
								textSize = "15sp",
								textColor = "#4F378B",
								gravity="left",
								layout_width = "match_parent",
...
luajava.runUiThread(function()
	...
	if not yck then ycg=850 yck=650 end
    	...
    	gnxs:setVisibility(View.VISIBLE)
	显示 = 1
...
launchui = luajava.loadlayout({
	...
	layout_width = "match_parent",
	{
		...
		gravity="center",
		{
			...
			background = getShape0(90,0xff4F378B,0xff4F378B,0xff4F378B),
			layout_height = "25dp",
			layout_width = "55dp",
			layout_gravity="center_horizontal",
...
checkbg = getVerticalBG({0xff4F378B,0xff4F378B},360)
...
changan.menu(
	{
		{--1
		particle("云烛ui","Made by Yunzhu","",{"#4F378B","#fff","#4F378B"}),
launchui,
...
--第四页
			--changan.switch("6"),
			particle("云烛ui","HarmonyOS4.0.0","",{"#4F378B","#fff","#4F378B"}),
			changan.switch ("杀戮光环" ,
				function ()
