...
local home = baseWindow:new({
	...
	onCreate = function(window)
		...
		element:addCardDemo('ShoppingCartTag', shoppingCart:newInstance())
		
		element:addCardDemo('主题', {
			MaterialSwitch,
			layout_width = 'match_parent',
			layout_height = 'wrap_content',
		...
		local element = newPager()
		element:addDemo('一键对接功能', function()
			window:startById('功能示例1')
		end)
		element:submit('功能示例')
...
baseWindow:new({
	...
	onCreate = function(window)
		...
		local function FunctionNameToShoppingTag(t)
			-- shoppingCart 允许所有 CompoundButton 的子类
			local shoppingCart = window:ShoppingCartTag()

			local t = {}
			
			function t:addMaterialSwitchs(names)
			...
			function t:addMaterialCheckBoxs(names)
				for i, name in ipairs(names) do
					shoppingCart:MaterialCheckBox({
						text = name,
						layout_width = 'match_parent',
		...
		local ShoppingTag = FunctionNameToShoppingTag()
		-- 所添加的功能必须定义在_ENV,参考72行
		ShoppingTag:addMaterialSwitchs({'功能1','功能2','功能3','功能4','功能5','功能6'})
		ShoppingTag:submit('MaterialSwitch')

		local ShoppingTag = FunctionNameToShoppingTag()
		ShoppingTag:addSwitchs({'功能1','功能2','功能3','功能4','功能5','功能6'})
		ShoppingTag:submit('Switch')

		local ShoppingTag = FunctionNameToShoppingTag()
		ShoppingTag:addMaterialCheckBoxs({'功能7','功能8','功能9','功能10'})
		ShoppingTag:submit('MaterialCheckBox')

		local ShoppingTag = FunctionNameToShoppingTag()
		ShoppingTag:addCheckBoxs({'功能7','功能8','功能9','功能10'})
		ShoppingTag:submit('CheckBox')
	end,
})
