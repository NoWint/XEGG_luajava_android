...
FrameLayout,
	...
	background = getHorizontalBG({0xff2b2b2b,0xff2b2b2b},0,2,0xff5b5963),--主题色cc7a00
...
cebian[#cebian+1] = {
	...
	background = getHorizontalBG({0xff1f1f1f,0xff1f1f1f},0,2,0xff1f1f1f),
...
_ENV["layout"..i] = luajava.loadlayout({
	...
	visibility = "gone",
	orientation = "vertical",
		background = getHorizontalBG({0xff111111,0xff111111},10,2,0xff000000),
		{ImageView,
	src=获取图片(stab[i][2]),
	layout_height = "15dp",
	layout_width="15dp",
...
显示 = 0
beij = getHorizontalBG({0xff000000,0xff000000},0,2,0xff000000)
...
checkbga = getVerticalBG({0x00000000,0x00000000},10)
checkbg = getVerticalBG({0xffb76d00,0xfcb76d00},10)
switchbg1 = getHorizontalBG({0x900e585f,0x900e585f},10,2,0xff047274)
switchbg2 = getHorizontalBG({0xffffffff,0xffffffff},10,2,0xffffffff)
nid = name..guid()
